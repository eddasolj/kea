...
$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();$jscomp.makeIterator=function(b){$jscomp.initSymbolIterator();var e=b[Symbol.iterator];return e?e.call(b):$jscomp.arrayIterator(b)};
...
(function(b,e){"function"===typeof define&&define.amd?define(["jquery"],e):"object"===typeof exports?e(require("jquery")):b.jQuery?e(b.jQuery):e(b.Zepto)})(this,function(b,e){b.fn.jPlayer=function(a){var c="string"===typeof a,f=Array.prototype.slice.call(arguments,1),d=this;a=!c&&f.length?b.extend.apply(null,[!0,a].concat(f)):a;if(c&&"_"===a.charAt(0))return d;c?this.each(function(){var c=b(this).data("jPlayer"),g=c&&b.isFunction(c[a])?c[a].apply(c,f):c;if(g!==c&&g!==e)return d=g,!1}):this.each(function(){var c=
b(this).data("jPlayer");c?c.option(a||{}):b(this).data("jPlayer",new b.jPlayer(a,this))});return d};b.jPlayer=function(a,c){if(arguments.length){this.element=b(c);this.options=b.extend(!0,{},this.options,a);var f=this;this.element.bind("remove.jPlayer",function(){f.destroy()});this._init()}};"function"!==typeof b.fn.stop&&(b.fn.stop=function(){});b.jPlayer.emulateMethods="load play pause";b.jPlayer.emulateStatus="src readyState networkState currentTime duration paused ended playbackRate";b.jPlayer.emulateOptions=
...
b=b.replace(/<br((\s*)|(\s[^>]*))\/?>/gi,"");b=b.replace(/<\/p>\s*<p(\s+[^>]*)?>/gi,"\n");return-1==b.indexOf("<")||null!=b.match(c)};b.isIos=function(){return null!=navigator.userAgent.match(/iPod|iPhone|iPad/i)};b.isAndroidDevice=function(){return null!=navigator.userAgent.match(/Android/i)};b.isAndroidBrowser=function(){return $("body").hasClass("h-android")};b.isIe=function(){return-1!==navigator.userAgent.indexOf("MSIE")||/rv:11.0/i.test(navigator.userAgent)};b.hideEmbeddedObjectsOnDialogOpening=
function(){b.setEmbeddedObjectsVisibility(!1,$("div.il-widget-content"),$("div.il-widget-content .h-userinput"))};b.showEmbeddedObjectsOnDialogClosing=function(){b.setEmbeddedObjectsVisibility(!0,$("div.il-widget-content"),$("div.il-widget-content .h-userinput"))};b.setEmbeddedObjectsVisibility=function(d,c,a){c&&c.find("applet").toggle(d);a&&(c=a.find("iframe,object"),b.isIe()?c.toggle(d):c.css("visibility",d?"visible":"hidden").toggleClass("h-visibility-hidden",!d))}})(b.CommonFunctions||(b.CommonFunctions=
{}));(function(b){})(b.CommonWindowMessages||(b.CommonWindowMessages={}));(function(b){})(b.CommonTriggers||(b.CommonTriggers={}))})(CCL||(CCL={}));var CommonConstants=CCL.CommonConstants,CommonFunctions=CCL.CommonFunctions,CommonWindowMessages=CCL.CommonWindowMessages,CommonTriggers=CCL.CommonTriggers;
...
a};a.adjustDialogPosition=function(a,c,f,b){a||(a=D);c||(c=F);b||(b=t.width());var d,e,g=k.outerWidth(),m=k.outerHeight(),n=t.scrollLeft(),q=t.scrollTop(),p=t.width()+n,w=t.height()+q,u=l.position().left;"auto"===h.align?e=p-a>g+h.marginLeft?a+h.marginLeft:a-g-h.marginRight:"center"===h.align?e=a-g/2:"left"===h.align?e=a-g-h.marginRight:"right"===h.align&&(e=a+h.marginLeft);"auto"===h.valign?d=window.innerHeight<=m?q:w-h.marginBottom-c>m+h.marginTop?c+h.marginTop:w-m-h.marginBottom:"top"===h.valign?
d=c-m-h.marginBottom:"center"===h.valign?d=c-m/2:"bottom"===h.valign&&(d=c+h.marginTop);f||(e=e<n?n:e);!h.canHaveNegativeTop&&0>d&&(d=0);k.css({top:d,left:e,bottom:""});if(d<=c&&d+m>c){var r="top";var y=Math.max(0,Math.min(c-d,m-12));e+g<a?k.addClass("left"):a<e&&k.addClass("right")}else e<=a&&e+g>a&&(r="left",y=Math.max(0,Math.min(a-e,g-12)),d>c?k.addClass("bottom"):d+m<c&&k.addClass("top"));"auto"===h.arrowOffset?"top"===r?v.css({top:y,left:""}):"left"===r&&v.css({top:"",left:y}):"manual"===h.arrowOffset?
(c={},void 0!=h.arrowTop&&(c.top=h.arrowTop),void 0!=h.arrowLeft&&(c.left=h.arrowLeft),v.css(c)):v.css({top:"",left:""});f&&(f=k.outerWidth()/2,0<f-u&&(k.css({left:h.marginLeft-u}),v.css({left:u-h.marginLeft+a})),b=f-(b-u-a-h.marginRight),0<b&&(k.css({left:a-f-b-h.marginRight}),v.css({left:f+b+h.marginRight})),z||(k.css("max-height",""),a=t.height()-d-h.marginBottom,0<a&&k.height()>a&&k.css("max-height",a)))};a.adjustDialogPositionOnHeightChange=function(a){var c=function(){var a=v.position().top,
c=a+v.outerHeight()-k.outerHeight();0<c&&(k.css("top",k.position().top+c),v.css("top",a-c))};a&&0<a?d(a,c):c()};a.setToggleElement=function(a){h.toggleElement=a};a.setWidth=function(a){h.width=a};a.toggleArrow=function(a){h.showArrow=a;g&&k.toggleClass("show-arrow",h.showArrow)};a.toggleMainContainerCssClass=function(a,c){k.toggleClass(a,c)};(function(){$.extend(h,e);p.uniqueId();h.noTitle&&p.remove();k.attr("role","dialog");f.addClass("ccl-context-dialog-content");if(h.fadeContentEdgesOnScroll){var c=
...
function(a){r.preventScrollTopOnAdjust=a};p.getIframe=function(){return t.contentContainer.find("iframe")};p.clearContent=function(){t.contentContainer.empty()};p.showContent=function(a){t.contentContainer.get(0).innerHTML=a;p.openDialog()};p.getHeaderContainer=function(){return t.headerContainer};p.verifyEmptyTitle=function(){var a=$("h2",t.headerContainer);a&&0===a.text().trim().length&&a.hide()};p.setTitle=function(a){var c=$("h2",t.headerContainer);c&&((a=a.trim())?(c.text(a),c.show()):c.hide())};
p.setTitleTooltip=function(a){var c=$("h2",t.headerContainer);c&&c.attr("title",a)};p.setAjaxUrl=function(a,c,f){r.ajaxUrl=a;S=c;f&&l()};p.setIframeUrl=function(a,c){r.iframeUrl=a;c&&n()};p.setIframeTitle=function(a){r.setIframeTitle=a};p.setCloseConfirmation=function(a){C=a};p.toggleDialogCloseButton=function(a){t.closeButton.toggleHyperlink(a)};p.getHeader=function(){return t.headerContainer};p.getContent=function(){return t.contentContainer};p.getFooter=function(){return t.footerContainer};p.adjustWindowSize=
function(){h()};p.setMode=function(a){u=a};p.setCustomScripts=function(a){y=a};p.clearLastActiveElement=function(){z=null};p.setAfterOpenDialog=function(a){y.afterOpenDialog=a};p.setAfterOpenDialogAjaxDynamicallySuccess=function(a){y.afterOpenDialogAjaxDynamicallySuccess=a};p.getIsOpened=function(){return w};return p}CssModal.commonSettings=void 0;CssModal.modes=void 0;CssModal.closeDialog=function(){window.location.hash="!"};CssModal.instances=[];
...
l.relatedWithDateInput&&l.relatedWithDateInput.fillMissingDateFromRelatedInput&&c&&""===window[l.relatedWithDateInput.id].getDateAsString()&&window[l.relatedWithDateInput.id].setDate(c);m.showDatePickerOnButtonClick?b.parent().find(".ui-datepicker-trigger").focus():(CCL.CommonFunctions.isIe()?(b.datepicker("option","showOn","button"),setTimeout(function(){b.focus();setTimeout(function(){b.datepicker("option","showOn","both")})})):b.focus(),k(b,f))}}).on("update",function(){if(l.settings.showWeek)if(l.settings.disableWeekSelection)$("td.ui-datepicker-week-col").addClass(n.disabled).wrapInner("<span></span>");
...
$("#ui-datepicker-div").hide();d()&&c();l.controls.dateInput.change(function(){if(l.onDateSelectedFunction){var a={dateText:l.getDateAsString(),dateFilterId:t?y:0};l.onDateSelectedFunction(a);l.triggerEventsOnChange()}}).keypress(function(a){a.which===CommonConstants.keyCodes.enter&&(l.controls.dateInput.change(),a.preventDefault())}).parent().find(".ui-datepicker-trigger").text(m.openText);if(q)l.controls.dateInput.keydown(function(a){a.which!==CommonConstants.keyCodes.tab&&(a.preventDefault(),a.which===
CommonConstants.keyCodes.del||a.which===CommonConstants.keyCodes.backspace)&&(l.clearDateAndTime(!1),l.closePicker(),$(l.controls.dateInput).trigger("change"))}).on("paste",function(a){a.preventDefault()})};l.closePicker=function(){l.controls.dateInput.datepicker("hide")};l.triggerEventsOnChange=function(){var a=d();a&&m.DateClearedEventName?$(l).trigger(m.DateClearedEventName):!a&&m.DateSetEventName&&$(l).trigger(m.DateSetEventName)};l.getDateAsString=function(){if(d())return"";var a=l.controls.dateInput.val();
return e(a)?a:""};l.getDateAsQueryStringParameter=function(){return $.datepicker.formatDate("yy-mm-dd",l.getDate())};l.getTime=function(){var a=$("#"+l.settings.timePickerSelectHourClientId),c=$("#"+l.settings.timePickerSelectMinuteClientId),f={};0<a.length&&0<c.length&&(f.hours=a.val(),f.minutes=c.val());return f};l.getDateTimeAsString=function(){var a=l.getDateAsString();if(""===a)return a;var c=l.getTime();return null==c.hours||null==c.minutes?a:a+" "+c.hours+":"+c.minutes};l.isDateValid=function(){if(d())return!1;
var a=l.controls.dateInput.val();return e(a)};l.getDate=function(){return d()?void 0:l.controls.dateInput.datepicker("getDate")};l.setDate=function(a){a&&e(a)?(l.controls.dateInput.removeClass(n.watermark),l.controls.dateInput.datepicker("setDate",a)):c()};l.setDefaultDate=function(a){var f=l.getDate();l.controls.dateInput.datepicker("option","defaultDate",a);l.setDate(f);d()&&c()};l.clearDateAndTime=function(c){d()||c||(l.setDate(""),m.DateClearedEventName&&$(l).trigger(m.DateClearedEventName));
r&&a().resetTimes()};l.setFilteringMode=function(a){t=a};l.setFilterId=function(a){y=a};l.focus=function(){l.controls.dateInput.focus()};l.isPickerVisible=function(){return $("#ui-datepicker-div").is(":visible")};l.isPickerClosing=function(){return C};return l}
...
return c instanceof b?c:b(this.options.templatesContainer).html(c).children()},_renderPreview:function(c,a){var f=this,e=this.options,h=b.Deferred();if(d){var k=0,l=function(){d(c,function(c){a.empty();var d=document.createElement("p");d.innerText=e.previewUploadedImageText;c.append(d);a.append(c);f._forceReflow(a);f._transition(a).done(function(){h.resolveWith(a)});b.contains(f.document[0].body,a[0])||h.resolveWith(a)},{maxWidth:e.previewMaxWidth,maxHeight:e.previewMaxHeight,canvas:e.previewAsCanvas,
orientation:k})};d.parseMetaData?d.parseMetaData(c,function(a){k=a.exif?a.exif.get("Orientation"):0;l()}):l();return h}return h.resolveWith(a)&&h},_renderPreviews:function(c){var a=this,f=this.options;c.context.find(".preview span").each(function(d,e){var g=c.files[d];f.previewSourceFileTypes.test(g.type)&&("number"!==b.type(f.previewSourceMaxFileSize)||g.size<f.previewSourceMaxFileSize)&&(a._processingQueue=a._processingQueue.pipe(function(){var f=b.Deferred(),d=b.Event("previewdone",{target:e});
a._renderPreview(g,b(e)).done(function(){a._trigger(d.type,d,c);f.resolveWith(a)});return f.promise()}))});return this._processingQueue},_renderUpload:function(c){return this._renderTemplate(this.options.uploadTemplate,c)},_renderDownload:function(c){return this._renderTemplate(this.options.downloadTemplate,c).find("a[download]").each(this._enableDragToDesktop).end()},_startHandler:function(c){c.preventDefault();c=b(c.currentTarget);var a=c.closest(".template-upload").data("data");a&&a.submit&&!a.jqXHR&&
a.submit()&&c.prop("disabled",!0)},_cancelHandler:function(c){c.preventDefault();var a=b(c.currentTarget).closest(".template-upload").data("data")||{};this._notifyAboutResultChanges();this._removeFileCallback&&this._removeFileCallback();a.jqXHR?a.jqXHR.abort():(a.errorThrown="abort",this._trigger("fail",c,a))},_deleteHandler:function(c){c.preventDefault();var a=b(c.currentTarget);this._trigger("destroy",c,b.extend({context:a.closest(".template-download"),type:"POST",dataType:this.options.dataType},
a.data()))},_forceReflow:function(c){return b.support.transition&&c.length&&c[0].offsetWidth},_transition:function(c){var a=b.Deferred();b.support.transition&&c.hasClass("fade")?c.bind(b.support.transition.end,function(f){f.target===c[0]&&(c.unbind(b.support.transition.end),a.resolveWith(c))}).toggleClass("in"):(c.toggleClass("in"),a.resolveWith(c));return a},_initButtonBarEventHandlers:function(){var c=this.element.find(".fileupload-buttonbar"),a=this.options.filesContainer;this._on(c.find(".start"),
{click:function(c){c.preventDefault();a.find(".start button").click()}});this._on(c.find(".cancel"),{click:function(c){c.preventDefault();a.find(".cancel button").click()}});this._on(c.find(".delete"),{click:function(f){f.preventDefault();a.find(".delete input:checked").siblings("button").click();c.find(".toggle").prop("checked",!1)}});this._on(c.find(".toggle"),{change:function(c){a.find(".delete input").prop("checked",b(c.currentTarget).is(":checked"))}})},_destroyButtonBarEventHandlers:function(){this._off(this.element.find(".fileupload-buttonbar button"),
...
typeof c&&(this._errorCallback=c)},setAdditionalClientValidationCallback:function(c){"function"==typeof c&&(this._additionalClientValidationCallback=c)},renderHiddenFieldContent:function(){var c=this.options,a=this.options.stateHiddenField.val();if((a=a?JSON.parse(a):[])&&0<a.length){var f=this._renderDownload(a);f.appendTo(c.filesContainer);var d=[];b.each(a,function(a,c){c.error&&0!=c.error.length||d.push(c)});0<d.length&&this._addFilesToList(d);this._adjustMaxNumberOfFiles(c.singleFileMode?-a.length:
-d.length);var e=[];b.each(a,function(a,f){f.type&&c.previewSourceFileTypes.test(f.type)&&f.fileUrl&&(e.push(f),e[e.length-1].toString=function(){return f.fileUrl})});0<e.length&&(a=f.data("data",{files:a}),this._renderPreviews({context:a,files:e}))}}})});var FixedHeader;
...
a.description&&(d="<div class='"+b.cssClasses.itemDescription+"'>"+a.description+"</div>");return a.isFolder?"<a href='#' class='"+b.cssClasses.folderLink+"' folderId='"+a.id+"'>"+c+"</a>"+d:c+d};e.getItemXML=function(a){var c=[];c.push("<Item>");c.push("<Id>"+a.id+"</Id>");c.push("<Item>"+CommonFunctions.htmlEncode(e.renderItemCell(a))+"</Item>");c.push("<Selectable>"+(!0===a.selectable?"true":"false")+"</Selectable>");c.push("</Item>");return c.join("")};e.renderGrid=function(a,c,d){a=e.cache[a];
e.controls.grid.pageNumber=c;e.controls.grid.pageSize=d;d=e.gridContainer.find("."+b.cssClasses.gridHeader+" > h2");var f=e.gridContainer.find("."+b.cssClasses.gridHeader+" > span");d.show();d.text(a.title);f.html(a.description);e.parentId=a.parentId;d=e.gridContainer.find("."+b.cssClasses.navigateUpLink);""===e.parentId?d.addClass(b.cssClasses.disabled):d.removeClass(b.cssClasses.disabled);e.controls.grid.clearSelection();e.toggleSelectButtons(!1);d=a.items.pages[c].length;f=[];f.push("<Data>");
f.push("<Items>");for(var g=0;g<d;g++)f.push(e.getItemXML(a.items.pages[c][g]));f.push("</Items>");f.push("<VirtualCount>"+a.virtualItemCount+"</VirtualCount>");f.push("</Data>");e.controls.grid.render(f.join(""),!1);$(e).trigger(b.eventNames.gridRender,[e.controls.grid,a])};e.showSuccessFeedback=function(){"undefined"!=e.insertFeedbackClientId&&window[e.insertFeedbackClientId].showMessage(b.feedbackTypes.info,b.terms.insertSuccessFeedbackText)};e.showErrorFeedback=function(){"undefined"!=e.insertFeedbackClientId&&
window[e.insertFeedbackClientId].showMessage(b.feedbackTypes.error,b.terms.insertErrorFeedbackText)};e.showProgressFeedback=function(){if("undefined"!=e.insertFeedbackClientId){var a=$("<span></span>").addClass(b.cssClasses.progressMessage).html(b.terms.insertProgressFeedbackText);window[e.insertFeedbackClientId].showMessage(b.feedbackTypes.info,a)}};e.hideSelectFeedback=function(){"undefined"!=e.insertFeedbackClientId&&window[e.insertFeedbackClientId].hide()};var c=function(a){var c=[];a&&(null!=
a.attr("nodeid")&&c.push([a.attr("nodeid"),a.children("a:first").contents().last().text()]),a.parentsUntil("."+b.cssClasses.treeContainer,"li").each(function(){var a=$(this);c.push([a.attr("nodeid"),a.children("a:first").contents().last().text()])}));e.hideRootCrumb||c.push([e.rootId,e.rootTitle]);var d=$("<ul />").addClass(b.cssClasses.crumbs);a=$("<nav />").addClass(b.cssClasses.crumbsWrapper).append(d);$.each(c,function(a,c){var f=$("<li />").append($("<span />").addClass(b.cssClasses.crumbsSeparator).text(b.breadCrumbsSeparator));
...
this.options.saveButtonClientId).trigger(CCL.ButtonLoadingIndicator.eventRemoveLoadingIndicator)},closeDialog:function(){this._closeDialog()},setCloseAfterSave:function(b){this.options.closeAfterSave=b},openEditor:function(b,c){this.activateButtons();this.updateEditorText(b);c&&""!=c&&window[this.options.dialogClientId].setTitle(c);window.location.href="#"+this.options.dialogClientId;setTimeout(function(){window.scroll(0,0)},100)},updateEditorText:function(b){this.options.editorClientId&&this.options.editorSetContentFuncName&&
(this.options.editorSetContentFuncName(b,this.options.editorClientId),window[this.options.dialogClientId].adjustWindowSize())}})})(jQuery);
...
!this._isAjaxEnabled&&this.options.processContentWebUrl&&this._editor.hybridEditor("setCloseAfterSave",!0);this._editor.hybridEditor("openEditor",this._isWatermarkApplied()&&!d?"":c,this.options.editorDialogTitle)}},_savePlainText:function(d,c){var a=b.trim(d.actualText);if(this._isAjaxEnabled){if(this.options.saveContentWebUrl&&this.options.webMethodParams){var f=this,e={};e[this.options.webMethodDataParamName]=encodeURIComponent(this._processPlainTextIgnoreNewLines(a));a=b.extend(this.options.webMethodParams,
...
(function(b){b.IframeResizer={reportSetIframeDefaultHeight:function(){var e;(e=b.parent)&&b!==e&&CommonFunctions.makePostMessageCall(e,{messageName:"setIframeDefaultHeight"})},registerDefaultHeight:function(e,d){function c(){g&&clearTimeout(g);g=setTimeout(k,200)}var a=$(b),f=$("#"+e.iframeClientId),g,h=CCL.CommonFunctions.calculateRightAndBottomOffset(f);var k=b[e.setIframeDefaultHeightFunctionName]=function(){var c=IframeResizer.getFixedIframeDefaultWidthAndHeight(a,f,h);f.height(c.height);d&&d({width:c.width+
8,height:c.height+8},f)};e.setIframeDefaultHeightImmediatelyAndOnResize&&(k(),a.resize(c));CommonFunctions.attachPostMessageEventListener(a,"setIframeDefaultHeight",function(a){k()})},getIframeDefaultWidthAndHeight:function(b,d,c){var a=CCL.CommonFunctions.isIosDevice(),f=a?screen.width:b.innerWidth();b=a?screen.height:b.innerHeight();d=d.offset();return{width:f-d.left-c.right,height:b-d.top-c.bottom}},getFixedIframeDefaultWidthAndHeight:function(b,d,c){b=IframeResizer.getIframeDefaultWidthAndHeight(b,
d,c);return{width:b.width-8,height:b.height-8}},registerExtensionIframeListener:function(e){var d=$("#"+e.IframeClientId);CommonFunctions.attachPostMessageEventListener($(b),[CommonWindowMessages.MessageNames.expandExtensionIframe,CommonWindowMessages.MessageNames.collapseExtensionIframe],function(c,a){var f=e.NotChangePosition,b=(c=c.messageName===CommonWindowMessages.MessageNames.expandExtensionIframe)?"0":"";d.css({position:c&&!f?"fixed":"",top:b,right:b,bottom:b,left:b});d.toggleClass(e.ExpandedIframeCssClass,
c);IframeResizer.reportSetIframeDefaultHeight();c&&CommonFunctions.makePostMessageCall(a,new CCL.CommonWindowMessages.GenericMessage(CommonWindowMessages.MessageNames.expandExtensionIframeDone))})}}})(window);
function postWidthAndHeightToExtension(b,e){e.get(0)&&CommonFunctions.makePostMessageCall(e.get(0).contentWindow,new CommonWindowMessages.GenericMessageWithData(CommonWindowMessages.MessageNames.extensionContentOpened,{iframeWidth:b.width&&0<b.width?b.width:e.width(),iframeHeight:b.height&&0<b.height?b.height:e.height()}))}function attachOnReadySendTitleToParent(){"complete"===document.readyState?sendDocumentTitleToParent():document.addEventListener("DOMContentLoaded",sendDocumentTitleToParent)}
function sendDocumentTitleToParent(){window.self!==(window.itslTop||window.top)&&window.parent.postMessage(JSON.stringify({messageName:"setIFrameTitleMessage",iFrameTitle:document.title}),"*")}
...
1;b("#popup_container").css({minWidth:g,maxWidth:g});b.alerts._reposition();b.alerts._maintainPosition(!0);if(b.alerts.draggable)try{b("#popup_container").draggable({handle:b("#popup_title")}),b("#popup_title").css({cursor:"move"})}catch(k){}b.alerts.focusTracker.startTrackFocus()},_hide:function(){b.alerts.focusTracker&&b.alerts.focusTracker.stopTrackFocus();b("#popup_container").remove();b.alerts._overlay("hide");b.alerts._maintainPosition(!1)},_overlay:function(e){switch(e){case "show":IframeResizer.reportSetIframeDefaultHeight();
b.alerts._overlay("hide");document.getElementsByTagName("html")[0].classList.add("jquery-alerts-has-overlay");b("BODY").append('<div id="popup_overlay"></div>');b("#popup_overlay").css({position:"fixed",zIndex:99998,top:"0",left:"0",right:"0",bottom:"0",background:b.alerts.overlayColor,opacity:b.alerts.overlayOpacity});break;case "hide":document.getElementsByTagName("html")[0].classList.remove("jquery-alerts-has-overlay"),b("#popup_overlay").remove()}},_reposition:function(){if(-1!=navigator.platform.indexOf("iPad"))if(90===
window.orientation||-90===window.orientation){var e=screen.width;var d=screen.height}else e=screen.height,d=screen.width;else e=b(window).height(),d=b(window).width();e=e/2-b("#popup_container").outerHeight()/2+b.alerts.verticalOffset;d=d/2-b("#popup_container").outerWidth()/2+b.alerts.horizontalOffset;0>e&&(e=0);0>d&&(d=0);b("#popup_container").css({top:e+"px",left:d+"px"});b("#popup_overlay").height(b(document).height())},_maintainPosition:function(e){if(b.alerts.repositionOnResize)switch(e){case !0:b(window).bind("resize",
b.alerts._reposition);break;case !1:b(window).unbind("resize",b.alerts._reposition)}}};jAlert=function(e,d,c){b.alerts.alert(e,d,c)};jConfirm=function(e,d,c){b.alerts.confirm(e,d,c)};jPrompt=function(e,d,c,a){b.alerts.prompt(e,d,c,a)};jMultiButtonConfirm=function(e,d,c,a){b.alerts.multiButtonConfirm(e,d,c,a)}})(jQuery);
...
g.updateSelectedItemsContainer=function(){g.updateContainerOnSelect&&(g.selectedContainer.empty(),g.emptyContainer.empty(),g.listIsEmpty()?g.toggleEmptyContentFeedback(!0):(g.setSelectedIds(g.selectedIds,!0),g.loadData(g.selectedIds,function(a){var c=[];$.each(a,function(a,b){g.renderSelectedItemHtml(b.id,b.title,b.description,b.type,b.options);c.push(b.id)});0===c.length&&g.toggleEmptyContentFeedback(!0)})),$(g).trigger(a.clientEvents.itemContainerUpdated))};g.createTooltip=function(a,c){var b=$("<span></span>");
b.text(a);var f=new ToolTip(null,b);f.title=$("<div/>").text(a).html();f.description=c;f.settings={showPopupTimeout:300,hidePopupTimeout:300,cssClasses:{tooltipPopup:"ccl-tooltip-popup",linkToTooltip:"ccl-tooltip-link",arrowUp:"ccl-tooltip-arrow-up",arrowDown:"ccl-tooltip-arrow-down",arrowContainer:"ccl-tooltip-arrow-container",tooltipTitle:"ccl-tooltip-popup-title",tooltipDescription:"ccl-tooltip-popup-description"}};f.initialize();return b};g.renderSelectedItemHtml=function(a,c,b,f,d){c=$("<div></div>").addClass(g.cssClasses.selectedItem).append($("<span></span>").addClass(g.cssClasses.selectedItemIcon).addClass(f)).append(g.showTooltip?
g.createTooltip(c,b):$("<span></span>").text(c));g.editable&&(a=$("<a></a>").data("loId",a).addClass(g.cssClasses.removeLink).attr("data-loId",a).attr("title",g.terms.deleteTooltip).attr("href","#").text("\u00d7"),void 0!==d&&a.data("options",d),c.append(a));g.selectedContainer.append(c)};g.getSelectedItemsSelector=function(){return String.format(".{0}",g.cssClasses.selectedItem)};g.listIsEmpty=function(){return 0==g.selectedIds.length};g.toggleEmptyContentFeedback=function(a){g.emptyContainer.toggle(a).text(a?
g.placeHolderOnEmpty:"")};g.showSuccessFeedback=function(){g.folderSelector.showSuccessFeedback()};g.showErrorFeedback=function(){g.folderSelector.showErrorFeedback()};g.showProgressFeedback=function(){g.folderSelector.showProgressFeedback()};g.addSelectedIds=function(c){var b={};$.each(g.selectedIds,function(a,c){b[c]=c});$.each(c,function(a,c){b[c]=c});g.selectedIds=[];$.each(b,function(a){g.selectedIds.push(a)});$(g).trigger(a.clientEvents.selectionChange);g.updateSelectedItemsContainer()};g.removeSelectedIds=
function(c){var b={};$.each(g.selectedIds,function(a,c){b[c]=c});$.each(c,function(a,c){delete b[c]});g.selectedIds=[];$.each(b,function(a){g.selectedIds.push(a)});$(g).trigger(a.clientEvents.selectionChange);g.updateSelectedItemsContainer()};g.clearSelectedIds=function(){g.selectedIds=[];$(g).trigger(a.clientEvents.selectionChange);g.updateSelectedItemsContainer()};g.setSelectedIds=function(a,c){g.selectedIds=a;g.toggleFolderSelectById(g.selectedIds,c)};g.toggleFolderSelectById=function(a,c){g.folderSelector&&
($.each(a,function(a,b){g.folderSelector.controls.grid.toggleSelectById(b,c)}),c&&g.folderSelector.toggleSelectButtons(!1))};g.loadData=function(c,b){var f=[],d={};$.each(c,function(a,c){void 0===g.cache[c]?f.push(c):d[c]=g.cache[c]});0==f.length?b(d):$.ajax({type:"GET",url:g.readLearningObjectivesUrl,data:{ids:f.join(",")},dataType:"json",xhrFields:{withCredentials:!0}}).done(function(a){$.each(a.Items,function(a,c){a={id:c.Id,title:c.Title,description:c.Description,type:c.Type};g.cache[c.Id]=a;
d[c.Id]=a});b(d)}).fail(function(){$(g).trigger(a.clientEvents.error)})};g.changeFilter=function(a){g.folderSelector.reinitialize(!0,g.filtersData[a])};if(e){var h=!1;e.getRequestData=function(a,c,b,f){a=g.baseGetRequestData(a,c,b,f);a.SelectableCategory=g.selectableCategory;a.SelectableLearningObjective=g.selectableObjective;a.SelectableSubject=g.selectableSubject;a.cutOffLoStructure=g.cutOffLoStructure;g.language&&(a.lan=g.language);return a};$(e).on(a.folderSelectorEvents.select,function(c,b){c=
h?[b.selectedId]:b.nodeIds;$(g).trigger(a.clientEvents.addItems,[c.filter(function(a){return 0>g.selectedIds.indexOf(a)})]);g.addSelectedIds(c)});if(a.restrictInsertContext)$(e).on(a.folderSelectorEvents.gridRender,function(a,c,b){if(h=b.virtualItemCount>b.folders.length)c.toggleSelectAll(!0),c.toggleEnableAll(!1)});else $(e).on(a.folderSelectorEvents.gridRender,function(a,c,b){$.each(g.selectedIds,function(a,b){c.toggleSelectById(b,!0)})});if(g.filtersddl)g.filtersddl.on("change",function(){g.changeFilter($(this).val())})}g.updateSelectedItemsContainer();
return g}
...
f=b.attr("rows")*b.attr("cols")*2;b.keypress(function(a){b.val().length>f&&a.preventDefault()});b.on("paste",function(){setTimeout(function(){b.val($.trim(b.val().replace(/[\n\r]+/g,"")));b.val(b.val().substring(0,f))},100)})}})};e.getInputForMetadataColumn=function(c){return $("#"+e.settings.modalDialogClientId+"_"+c.Name)};e.addLanguageLinkClick=function(){e.fillLanguageInfo(null)};e.editLanguageLinkClick=function(c,a){e.fillLanguageInfo(a)};e.dialogLoaded=function(){e.controls.languageInput.is(":visible")?
e.controls.languageInput.focus():e.getInputForMetadataColumn(e.metadataColumns[0]).focus()};e.saveLanguageClick=function(){e.clearValidators();var c={},a=!0,b=parseInt(e.controls.languageIdHidden.val());0>b&&(e.showValidationMessage(e.controls.languageInput,e.settings.requiredValidationMessage),a=!1);c[e.settings.metadataLanguageIdDataField]=b;$.each(e.metadataColumns,function(b,f){b=$.trim(e.getInputForMetadataColumn(f).val());e.validateMetadataColumn(f,b)||(a=!1);c[f.DataField]=b});if(!a)return!1;
...
h=0;h<a.length;h++)n=a[h]==e.pageSize?$("<li></li>").attr("class",d.selectedItem).text(a[h]):$("<li></li>").append($("<a></a>").attr("href","javascript:"+b+".changePageSize("+a[h]+");").text(a[h])),g.append(n);if(e.mode&e.settings.pagerMode.pageSizeDropdown){h=document.createElement("label");g=b+"DropDown";h.setAttribute("for",g);h.setAttribute("class",d.hiddenPageSizeChooserLabel);h.innerHTML=c.pageSizeChooserLabel;f.append(h);h=document.createElement("select");h.setAttribute("id",g);$(h).change(function(){window[b].changePageSize(this.options[this.selectedIndex].value)});
f.append(h);for(g=0;g<a.length;g++)n=document.createElement("option"),n.setAttribute("value",a[g]),n.innerText=CCL.CommonFunctions.formatString(c.pageSizeItemPrefix,a[g]),h.appendChild(n);$(h).find("option").each(function(){var a=$(this);if(a.val()==e.pageSize)return a.prop("selected",!0),!1})}e.mode&e.settings.pagerMode.pageSizeStaticLabel&&f.append($("<span/>").text(CCL.CommonFunctions.formatString(c.pageSizeItemPrefix,e.pageSize)).addClass(d.pageSizeStaticLabel))}};e.createIn=function(a){var c=
$("<div></div>").prop("className",d.main);a.append(c);e.controls.pagerContainer=c;e.render()};return e}
...
{id:-1,value:d.settings.selectAllText}).attr("class","ui-menu-item ccl-searchtextbox-select-all").appendTo(b);$("<button></button>").attr("type","button").text(d.settings.selectAllText).appendTo(c)}}}SearchTextBox.instances=[];SearchTextBox.initialize=function(){for(var b=0,e=this.instances.length;b<e;b+=1)this.instances[b].initialize()};
...
a)}function p(a){var b=c.caseSensitiveSearch?$(this).val():$(this).val().toUpperCase(),f=u.data("ui-autocomplete");f.widget().children(".ui-menu-item").each(function(){var a=$(this).data("ui-autocomplete-item");if((c.caseSensitiveSearch?a.value:a.value.toUpperCase())===b)return f.selectedItem=a,!1});f.selectedItem&&f._trigger("select",a,{item:f.selectedItem})}var v=!0,u=$("#"+c.textboxId),w=u.parent(),r=$("#"+c.hiddenSelectedValueId),t=b[c.textboxId]=u;t.notFound=!1;c.isDropDown&&(c.minLength=0);
u.autocomplete({autoFocus:!0,source:function(a,b){var f=$.map(c.values,function(b){var f=c.caseSensitiveSearch?a.term:a.term.toLowerCase(),g=c.caseSensitiveSearch?b.value:b.value.toLowerCase();switch(c.filterType){case d.commonSettings.filterType.wordStartsWith:return h(f,g)?b:e;default:return 0<=g.indexOf(f)?b:e}});f&&0!=f.length?(t.notFound=!1,b(f)):(t.notFound=!0,b([{id:-999,value:c.terms.noResults}]))},delay:c.delay,minLength:c.minLength,change:function(a,b){c.defaultText!==u.val()&&n(b)},close:function(a,
c){f&&f();v=!0},select:function(a,c){-999===c.item.id?(n(),a.preventDefault()):(t.selectValue(c.item),n())},open:function(a,b){c.zIndex&&u.autocomplete("widget").css("z-index",c.zIndex);v=!1},create:function(a,b){u.data("autocompleteItemId",c.defaultValue)},messages:{noResults:c.terms.noResults,results:function(a){return 1==a?t.notFound?c.terms.noResults:c.terms.oneResult:c.terms.resultsTemplate.replace("{0}",a.toString())}}});u.keyup(function(){q(!!u.val()&&!m(c.values,u.val()))}).keydown(function(a){a.which===
CommonConstants.keyCodes.enter&&(v||a.preventDefault(),c.defaultText!==u.val()&&(a.preventDefault(),n()),u.autocomplete("close"))}).click(l).on("autocompletesearchcomplete",function(a,c){});t.selectValue=function(a){q(!1);u.val(a.value);u.data("autocompleteItemId",a.id);$(".ui-autocomplete-input ui-autocomplete-loading").autocomplete("close");r.val()!==a.id&&(r.val(a.id),g&&g(a))};t.getValue=function(){return u.data("autocompleteItemId")};c.isDropDown&&($("#"+c.buttonId).click(k).click(l),u.click(k),
u.blur(p))}}})(window);
(function(b){var e={},d=!1,c=b.TextEditorManager={commonSettings:void 0,addStartupFunction:function(a,c){e[a]=c},textEditorSetup:function(){function a(a,c,b){if(a=a.getButton(c))b=$("#"+a.domId).removeClass().addClass(b).removeAttr("title"),a=b.find("span").removeClass(),b.append(document.createTextNode(a.text())),a.text("")}function f(){CommonFunctions.makePostMessageCallRecursivelyToTopmostFrame(b.parent,new CCL.CommonWindowMessages.GenericMessage(CommonWindowMessages.MessageNames.collapseExtensionIframe))}function g(a,
c,b){var f=a.getSelection(),d=f.getRanges(),e=CKEDITOR.plugins.link.getSelectedLink(a);e&&d[0].selectNodeContents(e);if(1===d.length){e=d[0];var g=new CKEDITOR.dom.text(c,a.document);e.collapsed?(e.insertNode(g),e.selectNodeContents(g)):(b.title=c,(a=a.widgets.focused)&&"image"==a.name&&(a.parts.link&&a.setData("link",null),"center"===a.data.align&&(a.data.link={linkText:c,type:"itslearningTreeLink"},Object.assign(a.data.link,b),a.shiftState({widget:a,element:a.element,oldData:a.oldData,newData:a.data}))));
...
(b.ErrorFeedbackMode={}));(function(b){b[b.Information=0]="Information";b[b.Error=1]="Error";b[b.Warning=2]="Warning";b[b.Tip=3]="Tip";b[b.RedError=4]="RedError"})(b.FeedbackType||(b.FeedbackType={}));(function(b){b[b.None=0]="None";b[b.NewTab=1]="NewTab";b[b.NewPopup=2]="NewPopup";b[b.Modal=3]="Modal";b[b.SameFrame=4]="SameFrame";b[b.Custom=5]="Custom"})(b.PreviewType||(b.PreviewType={}));(function(b){b[b.Statically=0]="Statically";b[b.AjaxStatic=1]="AjaxStatic"})(b.OverlayLoadMode||(b.OverlayLoadMode=
{}))})(CCL||(CCL={}));
...
function(a,c,b){if(b="string"===typeof b?b:b.toString()){if(-1<a.indexOf(c+"="))return a.replace(new RegExp(c+"=[^&]*(&|$)"),c+"="+encodeURIComponent(b)+"&");-1===a.indexOf("?")&&(a+="?");return a.slice(0,a.indexOf("?")+1)+c+"="+encodeURIComponent(b)+"&"+a.slice(a.indexOf("?")+1)}return-1<a.indexOf(c+"=")?a.replace(new RegExp(c+"=[^&]*(&|$)"),""):a};c.isIosDevice=b;c.isIphone=function(){return/iPhone/i.test(navigator.userAgent)};c.isAndroidDevice=d;c.isMobileDevice=function(){return b()||d()};c.isMobileOrTouchDevice=
function(){var a=navigator.userAgent||navigator.vendor||window.opera;return/Android|webOS|iPhone|iPad|iPod|IEMobile|Opera Mini|BlackBerry/i.test(a)||navigator.maxTouchPoints&&2<navigator.maxTouchPoints&&/Macintosh/.test(a)};c.isMobileSizedDevice=function(){return 768>window.innerWidth};c.isChrome=h;c.isIe=function(){return-1!==navigator.userAgent.indexOf("MSIE")||/rv:11.0/i.test(navigator.userAgent)};c.isEdge=function(){return-1!==navigator.userAgent.indexOf("Edge")};c.isFirefox=function(){return-1!==
navigator.userAgent.indexOf("Firefox")};c.isSafari=function(){return!h()&&-1!==navigator.userAgent.indexOf("Safari")};c.getIosVersion=function(){var a=navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/);if(void 0===a||null===a)return Number.NaN;a=[parseInt(a[1],10),parseInt(a[2],10),parseInt(a[3]||"0",10)];return parseFloat(a.join("."))};c.iPhoneVersion=function(){var a=window.screen.height,c=window.screen.width;return 320===c&&480===a?"4":375===c&&667===a?"6":414===c&&736===a?"6+":320===c&&568===
a?"5":480>=a?"2-3":"none"};c.makePostMessageCall=k;c.makePostMessageCallRecursivelyToTopmostFrame=l;c.makePostMessageCallWithData=function(a,c,b){a.postMessage(JSON.stringify($.extend(c,b)),"*")};c.attachPostMessageEventListener=function(a,c,b){a.on("message",function(a){var f,d=a.originalEvent.source;try{a.originalEvent.data&&(f=JSON.parse(a.originalEvent.data))&&f.messageName&&("string"===typeof c?f.messageName===c:-1!=c.indexOf(f.messageName))&&b(f,d)}catch(J){}})};c.checkScreenSize=function(c,
b){return window.matchMedia&&window.matchMedia(a("({0}-width: {1}px)",b?"min":"max",c)).matches};c.isPhoneScreenSize=m;c.isDesktopScreenSize=n;c.isTabletScreenSize=function(){return!n()&&!m()};c.executeScripts=function(a){if(null!==a){var c=[],b=a.match(/<script[^>]*?>/g);if(null!==b){var f=0,d,e=a.toLowerCase();for(d=0;d<b.length;d++){var g=a.indexOf(b[d],f)+b[d].length;f=e.indexOf("\x3c/script>",g);g=a.substring(g,f);c.push(g)}for(d=0;d<c.length;d++)(new Function(c[d]))()}}};c.safeParseCssValue=
q;c.calculateRightAndBottomOffset=function(a){var c=0,b=0;a.parentsUntil("html").each(function(a,f){a=$(f);c+=q(a,"padding-right")+q(a,"margin-right")+q(a,"border-right-width");b+=q(a,"padding-bottom")+q(a,"margin-bottom")+q(a,"border-bottom-width")});return{right:c,bottom:b}};c.getHtmlDocumentHeight=function(a){var c=0,b=function(a){for(var f=0;f<a.length;f++){var d=a[f];d.scrollHeight&&d.clientHeight&&(c=Math.max(d.scrollHeight,d.clientHeight,c));d.childNodes.length&&b(d.childNodes)}};b(a.documentElement.childNodes);
return c};c.alertAjaxError=function(a,b,f){a.status>=e.httpStatusCodes.badRequest&&a.responseText&&alert(c.htmlDecode(a.responseText))};c.jAlertAjaxError=function(a,b,f,d){p(c.htmlDecode(a),c.htmlDecode(b),f,d?function(){window.location=window.location}:null)};c.jAjaxAlert=p;c.jAjaxConfirm=function(a,c,b,f,d){$.alerts.okButton=b;$.alerts.cancelButton=f;jConfirm(a,c,d)};c.jAjaxPrompt=function(a,c,b,f,d,e){$.alerts.okButton=f;$.alerts.cancelButton=d;jPrompt(a,b,c,e)};c.jAjaxMultiButtonConfirm=function(a,
c,b,f){jMultiButtonConfirm(a,c,b,f)};c.printAndCloseCurrentPage=function(){function a(){b--;setTimeout(function(){0===c||0===b?(window.print(),window.close()):a()},1E3)}var c=$("iframe").length,b=c+1;$("iframe").load(function(){c--});a()};c.safeParseJson=function(a){try{return JSON.parse(a)}catch(F){return!1}};c.isOnScreen=function(a,c,f,d){void 0===c&&(c=1);void 0===f&&(f=1);void 0===d&&(d=null);var e=a.outerHeight(),g=a.outerWidth();if(!g||!e)return!1;var h=d?$(d):b()?$(window.parent):$(window),
k=h.scrollTop();d=h.scrollLeft();var m=d+h.width();h=k+h.height();a=a.offset();var l=a.left+g,n=a.top+e;if(m<a.left||d>l||h<a.top||k>n)return!1;k=Math.min(1,(n-k)/e);e=Math.min(1,(h-a.top)/e);return Math.min(1,(l-d)/g)*Math.min(1,(m-a.left)/g)>=c&&k*e>=f};c.measureKpi=function(a,c,b,f){void 0===f&&(f=null);try{return w({url:a,data:{measureSection:c,measurement:b,measureContext:f}})}catch(S){}};c.measureKpiSync=function(a,c,b,f,d){void 0===f&&(f=null);void 0===d&&(d=200);try{return w({url:a,timeout:d,
async:!1,data:{measureSection:c,measurement:b,measureContext:f}})}catch(H){}};c.kpiAjax=function(a,b,f){b||(b={});if(f&&!b.crossDomain){var d=b.beforeSend;b.beforeSend=function(a,c){d&&d(a,c);$.each(f,function(c,b){a.setRequestHeader("X-Kpi-"+c,b)})}}if(f&&b.crossDomain){var e="";$.each(f,function(a,b){e+=c.formatString("&{0}{1}={2}","X-Kpi-",a,b)});e=e.substring(1);a+=-1<a.indexOf("?")?"&":"?";a+=e}return $.ajax(a,b)};c.getDataSelector=function(a,b){5<a.length&&"data-"===a.substring(0,5)&&(a=a.substring(5));
return null!=b?c.formatString("[{0}{1}={2}]","data-",a,b):c.formatString("[{0}{1}]","data-",a)};c.isElementFullyShownInContainer=function(a,c){return v(a,c,c.offset().top)};c.isElementFullyShownInWindow=function(a){var c=$(window);return v(a,c,c.scrollTop())};c.preventInputIncorrectCharacters=function(a,c){-1!==$.inArray(a.which,c)||a.which===e.keyCodes.keyA&&(a.ctrlKey||a.metaKey)||a.which>=e.keyCodes.end&&a.which<=e.keyCodes.arrowDown||isNaN(a.key)&&a.preventDefault()};c.handleNavigationToAnchorsInUserInputInsideIframesResizedByTheirParents=
function(a){c.isIe()||document.addEventListener("click",function(c){var b,f;(b=c.target.closest(a+' a[href^="#"]:not([href="#"])'))&&(f=document.getElementById(b.getAttribute("href").slice(1)))&&(f.scrollIntoView(),c.preventDefault())})};c.safeAjax=u;c.safeAjaxPost=w;c.getAntiForgeryAjaxHeader=function(a){var c={};a&&a.headerName&&a.headerValue&&(c[a.headerName]=a.headerValue);return c};c.preventSubmitOnEnter=function(a){a.on("keypress",function(a){return a.which===e.keyCodes.enter?(a.preventDefault(),
!1):!0})};c.checkAndAddRole=function(a,c,b,f){c=$("#"+c);a&&c.length&&!c.is(":checked")&&f.push(b)};c.safeExecuteFunction=function(a){if(a)try{return a()}catch(F){}return!0}})(b.CommonFunctions||(b.CommonFunctions={}));(function(c){function a(a){return 621355968E9+1E4*a.getTime()}function b(a){return new Date(1970,0,1,0,0,0,(a-621355968E9)/1E4)}function d(a,c){a=b(a+6E8*c);return new Date(a.getFullYear(),a.getMonth(),a.getDate(),0,0,0)}c.convertToTicks=a;c.convertTicksStringToDate=function(a,c){a=
parseInt(a);return d(a,c)};c.convertTicksToDateExact=b;c.convertUtcTicksToLocalClientDate=function(a){return new Date((a-621355968E9)/1E4)};c.convertLocalProfileDateToEndOfDayUtcTicks=function(c,b){c=new Date(Date.UTC(c.getFullYear(),c.getMonth(),c.getDate(),23,59,59));return a(c)+-6E8*b};c.convertUtcTicksToLocalProfileDate=d;c.getItslNow=function(a){var c=new Date,b=6E4*c.getTimezoneOffset();return new Date(c.getTime()+b+1E3*a)}})(b.DateFunctions||(b.DateFunctions={}));(function(c){var a=function(){function a(){}
a.maskNavigationBar="maskNavigationBar";a.unmaskNavigationBar="unmaskNavigationBar";a.registerExtraNavBar="registerExtraNavBar";a.unregisterExtraNavBar="unregisterExtraNavBar";a.collapseContentAreaFrame="collapseContentAreaFrame";a.expandContentAreaFrame="expandContentAreaFrame";a.contentAreaFrameHasCollapsed="contentAreaFrameHasCollapsed";a.contentAreaFrameHasExpanded="contentAreaFrameHasExpanded";a.collapseExtensionIframe="collapseExtensionIframe";a.expandExtensionIframe="expandExtensionIframe";
a.expandExtensionIframeDone="expandExtensionIframeDone";a.collapseLeftMenu="collapseLeftMenu";a.extensionContentSaved="extensionContentSaved";a.unseenNotificationCounterChanged="unseenNotificationCounterChanged";a.extensionContentChanged="extensionContentChanged";a.extensionAssignmentAnswerOpened="extensionAssignmentAnswerOpened";a.textEditorInteraction="textEditorInteraction";a.extensionCancelActionPerformed="extensionCancelActionPerformed";a.extensionContentViewed="extensionContentViewed";a.extensionContentOpened=
"extensionContentOpened";a.nestedCssModalDialogExpanded="nestedCssModalDialogExpanded";a.nestedCssModalDialogCollapsed="nestedCssModalDialogCollapsed";a.studentWasAssessed="studentWasAssessed";a.submitIframe="submitIframe";a.closeCssModalDialog="closeCssModalDialog";a.editEmbededContent="editEmbededContent";a.extensionPrintContentFrame="extensionPrintContentFrame";a.getEmbeddedContentData="getEmbeddedContentData";a.getEmbeddedContentSize="getEmbeddedContentSize";a.openPersonProfileCard="openPersonProfileCard";
a.changePrintFeatureVisibility="changePrintFeatureVisibility";a.hideSettings="hideSettings";a.showSettings="showSettings";a.toggleBreadcrumbs="toggleBreadcrumbs";a.suspendUpdateBreadCrumbsAndNavigation="suspendUpdateBreadCrumbsAndNavigation";a.suspendExpandCollaplseContentAreaFrame="suspendExpandCollaplseContentAreaFrame";a.extensionSettingsChanged="extensionSettingsChanged";a.showBottomNavigationBar="showBottomNavigationBar";a.hideBottomNavigationBar="hideBottomNavigationBar";a.iframeAutoHeight=
"iframeAutoHeight";a.reloadParentIframe="reloadParentIframe";a.assignmentShowManageRubric="showManageRubricDialog";a.extensionOnboarding="extensionOnboarding";a.extensionReadyForTelemetryRequests="extensionReadyForTelemetryRequests";a.initialiseTelemetryCampaign="initialiseTelemetryCampaign";a.extensionTelemetryResultAnswer="extensionTelemetryResultAnswer";a.extensionTelemetryResultComment="extensionTelemetryResultComment";a.unreadMessagesCounterChanged="unreadMessagesCounterChanged";a.enableFullScreen=
"enableFullScreen";a.disableFullScreen="disableFullScreen";a.extensionTitleUpdated="extensionTitleUpdated";a.elementAddedToYourCollection="elementAddedToYourCollection";a.fullScreenDialogOpening="fullScreenDialogOpening";a.fullScreenDialogCollapseTitle="fullScreenDialogCollapseTitle";a.backToPreviousPage="backToPreviousPage";a.mediaRecorderContentSaved="mediaRecorderContentSaved";a.mediaRecorderClosed="mediaRecorderClosed";a.cloudFilePermissionError="cloudFilePermissionError";a.setIFrameTitle="setIFrameTitle";
a.openGroupChat="openGroupChat";a.adminConsentTenant="adminConsentTenant";a.oAuthSuccessful="oAuthSuccessful";a.askExtensionParentFrameWhetherTopFrameExists="askExtensionParentFrameWhetherTopFrameExists";a.replyToExtensionFrameWhenTopFrameExists="replyToExtensionFrameWhenTopFrameExists";a.scrollToTop="scrollToTop";a.askIfCustomTreeLinkNavigationRequired="askIfCustomTreeLinkNavigationRequired";a.customTreeLinkNavigationIsRequired="customTreeLinkNavigationIsRequired";a.customTreeLinkNavigationEvent=
"customTreeLinkNavigationEvent";a.customTreeLinkNavigationSetUp="customTreeLinkNavigationSetUp";a.customTreeLinkNavigationRemoved="customTreeLinkNavigationRemoved";a.googleClassroomImportStarted="googleClassroomImportStarted";a.refreshTreeMenuRootFolder="refreshTreeMenuRootFolder";a.edgeImmersiveReaderReadable="edgeImmersiveReaderReadable";a.iframeIsLoaded="iframeIsLoaded";a.popupIsLoaded="popupIsLoaded";a.deepLinkContentReceived="deepLinkContentReceived";a.askWhetherItslearningIsEmbedded="askWhetherItslearningIsEmbedded";
a.replyIfItslearningIsEmbedded="replyIfItslearningIsEmbedded";a.replaceTopFrame="replaceTopFrame";return a}();c.MessageNames=a;var b=function(){return function(a){this.messageName=a}}();c.GenericMessage=b;var d=function(a){function c(c,b){a.call(this,c);this.extendedData=b}__extends(c,a);return c}(b);c.GenericMessageWithData=d;d=function(c){function b(b,f,d){void 0===f&&(f=!1);void 0===d&&(d="");c.call(this,a.textEditorInteraction);this.interactionType=b;this.closeDialogAfterPerformingOperation=f;
this.editorInstanceId=d}__extends(b,c);return b}(b);c.TextEditorBaseInteractionMessage=d;var e=function(a){function c(c,b,f,d){void 0===f&&(f=!1);void 0===d&&(d="");a.call(this,c,f,d);this.extendedData=b}__extends(c,a);return c}(d);c.TextEditorBaseInteractionWithDataMessage=e;var k=function(a){function c(){a.call(this,l.CloseDialog,!0)}__extends(c,a);return c}(d);c.TextEditorCloseDialogMessage=k;k=function(a){function c(c,b,f,d){void 0===b&&(b=!1);void 0===f&&(f="");void 0===d&&(d=!1);a.call(this,
l.InsertHtml,b);this.htmlContent=c;this.editorInstanceId=f;this.isEmbeddedImage=d}__extends(c,a);return c}(d);c.TextEditorInsertHtmlMessage=k;k=function(a){function c(c,b,f){void 0===f&&(f=!1);a.call(this,l.InsertLinkToFile,f);this.linkUrl=c;this.linkName=b}__extends(c,a);return c}(d);c.TextEditorInsertLinkToFileMessage=k;k=function(a){function c(c){a.call(this,l.UpdateItslPluginsList,!0);this.pluginId=c}__extends(c,a);return c}(d);c.TextEditorUpdateItslPluginListMessage=k;k=function(a){function c(c){a.call(this,
l.SendImageSettingsToImagePropertiesDialog,c)}__extends(c,a);return c}(e);c.TextEditorSendImageSettingsMessage=k;e=function(a){function c(c){a.call(this,l.InsertImageToSlideshow,c,!0)}__extends(c,a);return c}(e);c.TextEditorInsertImageToSlideshow=e;e=function(a){function c(c,b,f,d,e){void 0===e&&(e=!1);a.call(this,l.InsertTextLink,e);this.linkUrl=c;this.linkText=b;this.linkTarget=f;this.linkAdditionalAttributes=d}__extends(c,a);return c}(d);c.TextEditorInsertTextLink=e;d=function(a){function c(){a.call(this,
l.ScaleDialog,!0)}__extends(c,a);return c}(d);c.TextEditorScaleDialog=d;b=function(a){function c(c){a.call(this,c)}__extends(c,a);return c}(b);c.EmbedContentBaseMessage=b;d=function(c){function b(){c.call(this,a.getEmbeddedContentData)}__extends(b,c);return b}(b);c.EmbeddedContentDataMessage=d;b=function(c){function b(){c.call(this,a.getEmbeddedContentSize)}__extends(b,c);return b}(b);c.EmbeddedContentSizeMessage=b;(function(a){a[a.CloseDialog=0]="CloseDialog";a[a.InsertHtml=1]="InsertHtml";a[a.InsertLinkToFile=
2]="InsertLinkToFile";a[a.UpdateItslPluginsList=3]="UpdateItslPluginsList";a[a.SendImageSettingsToImagePropertiesDialog=4]="SendImageSettingsToImagePropertiesDialog";a[a.InsertImageToSlideshow=5]="InsertImageToSlideshow";a[a.InsertTextLink=6]="InsertTextLink";a[a.ScaleDialog=7]="ScaleDialog"})(c.TextEditorInteractionType||(c.TextEditorInteractionType={}));var l=c.TextEditorInteractionType})(b.CommonWindowMessages||(b.CommonWindowMessages={}));(function(c){c.clickInInnerFrame="clickInInnerFrame";c.touchstartInInnerFrame=
"touchstartInInnerFrame"})(b.CommonTriggers||(b.CommonTriggers={}));var d=function(){function c(a){var c=this;this.trackFocusHandler=function(a){if(a.keyCode===$.ui.keyCode.TAB&&!a.isDefaultPrevented()){var b=c.$container.find(":tabbable,iframe"),f=b.filter(":first"),d=b.filter(":last");if(d.is("iframe"))try{d=d.contents().find(":tabbable,iframe").filter(":last")}catch(m){}a.target!==d[0]&&a.target!==c.$container||a.shiftKey?a.target!==f[0]&&a.target!==c.$container||!a.shiftKey||(setTimeout(function(){d.trigger("focus")},
100),a.preventDefault()):(setTimeout(function(){f.trigger("focus")},100),a.preventDefault())}};this.$container=a}c.prototype.startTrackFocus=function(){this.isFocusTracked()||this.$container.keydown(this.trackFocusHandler)};c.prototype.stopTrackFocus=function(){this.isFocusTracked()&&this.$container.off("keydown",this.trackFocusHandler)};c.prototype.isFocusTracked=function(){var a=this;if(!this.$container.data("events"))return!1;var c=this.$container.data("events").keydown;if(!c)return!1;var b=!1;
$.each(c,function(c,f){if(f.handler===a.trackFocusHandler)return b=!0,!1});return b};return c}();b.FocusTracker=d;d=function(){return function(c,a,b){void 0===b&&(b="");this.text=c;this.css=a;this.customId=b}}();b.ConfirmButtonMetaData=d;d=function(){return function(){}}();b.MultiButtonConfirmResult=d})(CCL||(CCL={}));
...
(function(b){var e=function(){function d(c){var a=this;this.settings=c;this.onEscape=function(c){c.which===b.CommonConstants.keyCodes.escape&&a.closeDialog()};this.closeTooltip=function(c){return setTimeout(function(){return a.toolTip.closeTooltip()},c)};this.openTooltip=function(c,b,d){setTimeout(function(){a.toolTip.isTooltipOpened()||a.$tooltipContentLabel.html(b);a.toolTip.openTooltip(c,a.tooltipPositionSettings)},d)};window[d.clientInstanceName]=this;$(function(){a.$body=$("body");a.$bodyWrapper=
$("."+a.settings.Css.BodyWrapper);a.$dialog=$("#"+a.settings.Controls.Dialog);a.$closeButton=a.$dialog.find("."+a.settings.Css.CloseButton);a.$errorLabel=$("#"+a.settings.Controls.ErrorLabel);a.$tooltipContentLabel=$("#"+a.settings.Controls.TooltipContentLabel);a.$contentContainer=$("#"+a.settings.Controls.ContentContainer);a.$iframe=$("#"+a.settings.Controls.Iframe);a.$loadingIndicator=$("#"+a.settings.Controls.LoadingIndicator);a.focusTracker=new b.FocusTracker(a.$dialog);a.$closeButton.click(function(){a.closeDialog()});
a.initTooltip();a.settings.Terms.CloseTooltip&&a.toggleToolTip(a.$closeButton,a.settings.Terms.CloseTooltip,!0);b.CommonFunctions.attachPostMessageEventListener($(window),b.CommonWindowMessages.MessageNames.fullScreenDialogCollapseTitle,function(){a.$dialog.toggleClass(a.settings.Css.NoHeader)}.bind(a));a.notifyPlayPlanDialog()})}d.getInstance=function(){return window[d.clientInstanceName]};d.openDialog=function(c,a){d.getInstance().openDialog(c,a)};d.prototype.isOpened=function(){return this.$dialog.is(":visible")};
d.prototype.closeDialogWithoutConfirm=function(){$(this).trigger(d.onCloseEvent);this.$contentContainer.empty();this.toggleDialog(!1)};d.prototype.closeDialog=function(){var c=this,a=$.Deferred(),b=new CustomEvent(d.onCloseCancelableEvent,{bubbles:!0,cancelable:!0,detail:a});this.$dialog.get(0).dispatchEvent(b)?this.closeDialogWithoutConfirm():a.done(function(){c.closeDialogWithoutConfirm()})};d.prototype.openDialog=function(c,a){this.toggleDialog(!0);if(this.settings.UseIframe)return this.setFrameUrl(c),
a&&this.setFrameTitle(a),null;c=this.updateContent(c);this.toggleDialog(!0);return c};d.prototype.openDialogWithContent=function(c){this.updateContentWithHtmlString(c);this.toggleDialog(!0)};d.prototype.updateContent=function(c){var a=this,b=$.Deferred();if(!c)return console.error("Url to load not set"),b.reject("Url to load not set"),b.promise();this.$contentContainer.empty();this.$loadingIndicator.show();$.get(c).done(function(c){a.$contentContainer.html(c);b.resolve(a)}).fail(function(a){b.reject(a)}).always(function(){a.$loadingIndicator.hide()});
return b.promise()};d.prototype.setFrameUrl=function(c){var a=this;this.$loadingIndicator.show();this.$iframe.contents().find("html").html("");c&&this.$iframe.prop("src",c).load(function(){a.$loadingIndicator.hide()})};d.prototype.setFrameTitle=function(c){this.$iframe.attr("title",c)};d.prototype.updateContentWithHtmlString=function(c){this.$contentContainer.empty();this.$contentContainer.html(c)};d.prototype.notifyPlayPlanDialog=function(){var c=window.parent;c&&window!==c&&b.CommonFunctions.makePostMessageCall(c,
new b.CommonWindowMessages.GenericMessage(b.CommonWindowMessages.MessageNames.fullScreenDialogOpening))};d.prototype.toggleDialog=function(c){var a=this;this.toggleEscapeHandler(c);this.adjustDialogPositionOnIosDevice(c);this.$body.toggleClass(b.CommonCssClasses.FullScreenDialog.Opened,c);this.$dialog.toggle(c);c?(this.expandContentAreaFrame(),this.$startLink=$(":focus"),this.$closeButton.focus(),this.focusTracker.startTrackFocus(),$(document).on("cssmodal:show",function(){return a.toggleEscapeHandler(!1)}).on("cssmodal:hide",
function(){return a.toggleEscapeHandler(!0)})):(this.collapseContentAreaFrame(),this.focusTracker.stopTrackFocus(),this.$startLink.focus())};d.prototype.expandContentAreaFrame=function(){this.settings.IsOpenedInExtension?b.CommonFunctions.makePostMessageCall(window,new b.CommonWindowMessages.GenericMessage(b.CommonWindowMessages.MessageNames.enableFullScreen)):(this.suspendUpdateBreadCrumbsAndNavigation(!0),b.CommonFunctions.makePostMessageCall(window.top,{messageName:b.CommonWindowMessages.MessageNames.expandContentAreaFrame}),
this.suspendExpandCollaplseContentAreaFrame(!0),IframeResizer.reportSetIframeDefaultHeight())};d.prototype.collapseContentAreaFrame=function(){this.settings.IsOpenedInExtension?b.CommonFunctions.makePostMessageCall(window,new b.CommonWindowMessages.GenericMessage(b.CommonWindowMessages.MessageNames.disableFullScreen)):(this.suspendUpdateBreadCrumbsAndNavigation(!1),this.suspendExpandCollaplseContentAreaFrame(!1),b.CommonFunctions.makePostMessageCall(window.top,{messageName:b.CommonWindowMessages.MessageNames.collapseContentAreaFrame}))};
d.prototype.suspendUpdateBreadCrumbsAndNavigation=function(c){b.CommonFunctions.makePostMessageCall(window.top,new b.CommonWindowMessages.GenericMessageWithData(b.CommonWindowMessages.MessageNames.suspendUpdateBreadCrumbsAndNavigation,{suspend:c}))};d.prototype.suspendExpandCollaplseContentAreaFrame=function(c){b.CommonFunctions.makePostMessageCall(window.top,new b.CommonWindowMessages.GenericMessageWithData(b.CommonWindowMessages.MessageNames.suspendExpandCollaplseContentAreaFrame,{suspend:c}))};
d.prototype.toggleEscapeHandler=function(c){if(c)this.$body.on("keyup",this.onEscape);else this.$body.off("keyup",this.onEscape)};d.prototype.adjustDialogPositionOnIosDevice=function(c){if(b.CommonFunctions.isIosDevice()&&!this.settings.IsOpenedInExtension){var a=$(window.itslTop||window.top).height()-this.$closeButton.height();this.$bodyWrapper.css("overflow",c?"hidden":"");this.$bodyWrapper.height(c?a.toString():"auto")}};d.prototype.showErrorMessage=function(c){this.$errorLabel.text(c);this.$errorLabel.show()};
d.prototype.initTooltip=function(){this.tooltipPositionSettings={My:"right+23 top",At:"center bottom+10",Arrow:"bottom"};this.$toolTipContainer=this.$dialog.find("."+this.settings.Css.ToolTipContentContainer);this.toolTip=new b.CustomTooltip("fullScreenDialogToolTip",{contentContainer:this.$toolTipContainer,zIndex:10},this.settings.Css.CustomTooltipCssClasses);this.$toolTipContainer.show()};d.prototype.toggleToolTip=function(c,a,f){var d=this;if(!b.CommonFunctions.isMobileDevice())if(f)c.on("mouseover",
...
(function(b){var e=function(){function b(){this.skipUrls=[]}b.prototype.getFirstLink=function(c){c=this.parseFirstLink(this.getTextWithoutWordsWithDiacritics(this.getTextWithoutSkippedUrls(this.getEmbedCodeWithoutStyles(c))));return""===c?"":b.ensureUrlScheme(c)};b.prototype.getDomain=function(c){var a=document.createElement("a");a.href=c;return a.hostname};b.prototype.skipUrl=function(c){this.skipUrls.push(c)};b.prototype.removeFromSkipUrl=function(c){c=this.skipUrls.indexOf(c);-1<c&&this.skipUrls.splice(c,
1)};b.prototype.isEmail=function(c){for(var a=c.length-1;0<=a&&!c.charAt(a).match(b.lettersRegex);)a--;return null!==c.substr(0,a+1).match(b.emailRegex)};b.ensureUrlScheme=function(c){b.urlWithFirstAtSignRegex.test(c)&&(c=c.substr(c.indexOf("@")+1));return b.schemeDefinedUrlRegex.test(c)?c:b.protocolRelativeUrlRegex.test(c)?"http:"+c:"http://"+c};b.prototype.getEmbedCodeWithoutStyles=function(c){return c.replace(b.stylesRegex,"")};b.prototype.getTextWithoutSkippedUrls=function(c){var a=this;return this.skipUrls.reduce(function(c,
d){var f=a.parseFirstLink(c);return b.ensureUrlScheme(f)===d?c.replace(f," "):c},c)};b.prototype.getTextWithoutWordsWithDiacritics=function(c){return c.replace(b.wordsWithDiacritics,"")};b.prototype.getDataAttribute=function(c){var a=null;c.match(b.dataAttributesRegex)&&(a=c.replace(b.dataAttributesRegex,b.dataAttributesTemplate));return a};b.prototype.parseFirstLink=function(c){var a=this.getDataAttribute(c),f=c.match(b.urlRegex);if(null!==f&&b.dateRegex.test(f[0]))return"";for(;""!==c&&null!==f&&
(this.isEmail(f[0])||0===f[0].trim().indexOf("@"));)c=c.replace(f[0]," ").trim(),f=c.match(b.urlRegex);return null===f?"":a?f[0]+(-1<f[0].indexOf("?")?"&":"?")+a:f[0]};b.wholeUrlRegex=/^(https?:\/\/)?((((?!-))(xn--)?[a-z0-9-_@]{0,61}[a-z0-9]{1,1}\.)*(xn--)?([a-z0-9\-@]{1,61}|[a-z0-9-]{1,30}\.[a-z]{2,})\.)([a-zZ-Z0-9\.\-\/\\_%,!:\+@=]{2,})(\?([^#\s>"]*))?(#(\S*))?$/i;b.urlRegex=/(https?:\/\/)?((((?!-))(xn--)?[a-z0-9-_@]{0,61}[a-z0-9]{1,1}\.)*(xn--)?([a-z0-9\-@]{1,61}|[a-z0-9-]{1,30}\.[a-z]{2,})\.)([a-zZ-Z0-9\.\-\/\\_%,!:\+@=]{2,})(\?([^#"'\s>"]*))?(#([^"'\s]*))?/i;
b.emailRegex=/(mailto:([^\?]*))?([a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$)/i;b.schemeDefinedUrlRegex=/^(https?:\/\/)/i;b.protocolRelativeUrlRegex=/^(\/\/)/;b.urlWithFirstAtSignRegex=/^((https?:)?\/\/)?@/i;b.lettersRegex=/^[a-z]$/i;b.stylesRegex=/(style\s*=\s*)(?:(?:[^>']([^>"]*))|(?:[^>"]([^>']*)))/ig;b.wordsWithDiacritics=/([A-Za-z0-9._%+-]*[\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u0131\u0134-\u0151\u0154-\u017e\u01cd-\u01f0\u01f4-\u01f5\u01f8-\u021b\u021e-\u021f\u0224-\u0233\u0243\u0246-\u024f\u1e00-\u1e9e\u0180-\u0193\u0197-\u019a\u019d-\u01a1\u01a4-\u01a5\u01ab-\u01b0\u01b2-\u01b6\u1ea0-\u1eff\u0386\u0388-\u03ce]+[A-Za-z0-9._%+-]*)+/ig;
b.dateRegex=/(\s|^)\d{1,4}\.\d{1,4}(\.\d{1,4})?(\s|$)/;b.dataAttributesRegex=/(<div.+?data-nrk-id="([\d]+)".+)|(<div.+?data-sample-id="([\d]+)".+)/i;b.dataAttributesTemplate="data-id=$2$4";return b}();b.LinkParser=e})(CCL||(CCL={}));
...
a,0,c.Comment))});this.controls.container.find("div."+this.cssClasses.overrideStatusBoxContainer).each(function(a,c){a=$(c).attr(b.dataAttributes.learningObjectiveId);var f=$(c).attr(b.dataAttributes.learningObjectiveGroupId);b.setStatusOverridings(a,f,"",0,"",$(c))})};b.prototype.toReadOnlyMode=function(){this.controls.container.removeClass(this.cssClasses.assessMode);this.controls.container.addClass(this.cssClasses.readOnlyMode);this.toggleAssessmentCallback(!1);this.toggleAssessmentControls(!1)};
b.prototype.toAssessMode=function(){this.controls.container.addClass(this.cssClasses.assessMode);this.controls.container.removeClass(this.cssClasses.readOnlyMode);this.toggleAssessmentCallback(!0);this.toggleAssessmentControls(!0)};b.prototype.get=function(){var c=this,a=[];$.each(this.assessmentsData,function(b,d){var f=c.descriptionsData[b];a.push({AssessedAchievementLevelId:d,RubricCriteriaItemId:b,Comment:null!=f?f:null})});$.each(this.overriddenAssessmentsData,function(b,d){b=c.getStartsAtByAssessmentStatusType(d.Status);
a.push({LearningObjectiveId:d.LearningObjectiveId,LearningObjectiveGroupId:d.LearningObjectiveGroupId,Override:!0,PercentScore:b})});return a};b.prototype.clear=function(){var c=this;this.controls.container.find("li."+this.cssClasses.criteriaDescriptionRow).each(function(a,b){c.setDescriptionValue($(b),"")});this.descriptionsData={};this.controls.updatedCriteriaDecriptionsHidden.val(JSON.stringify(this.descriptionsData));this.controls.container.find("div."+this.cssClasses.overrideStatusBoxContainer).each(function(a,
b){a=$(b).attr(c.dataAttributes.learningObjectiveId);var f=$(b).attr(c.dataAttributes.learningObjectiveGroupId);c.setStatusOverridings(a,f,"",0,"",$(b))});this.overriddenAssessmentsData={};var a=this.controls.container.find("div > span."+this.cssClasses.statusBox);this.updateStatusTextAndCss(a,this.settings.assessmentStatusTypeNotAssessed);this.controls.container.find("ul li."+this.cssClasses.column).each(function(a,b){$(b).hasClass(c.cssClasses.selectedBox)&&c.assess($(b),!0)});this.assessmentsData=
{}};b.prototype.saveStatusOverridings=function(c,a,b,d){this.settings.showOverride&&(b=b.toString(),d=d.toString(),c=0<c.length?parseInt(c):0,this.saveOverridingsCommon(b,d,c,0,"",a.controls.container.parents("div."+this.cssClasses.overrideStatusBoxContainer).first()))};b.prototype.toggleAssessmentControls=function(c){var a=this;this.controls.container.find("li."+this.cssClasses.criteriaDescriptionRow).each(function(b,d){b=$(d);b.children("a."+a.cssClasses.criteriaLevelDescription).toggle(c);b.children("span."+
a.cssClasses.criteriaLevelDescription).remove();c?b.show():(d=b.children("input").val())?b.append($("<span/>").prop("class",a.cssClasses.criteriaLevelDescription).text(d)):b.hide()});this.controls.container.find("."+this.cssClasses.outcomeRow).toggle(c)};b.prototype.toggleAssessmentCallback=function(c){var a=this;$("ul li."+this.cssClasses.column,this.controls.container).each(function(b,d){b=$(d);b.off("click.assess");if(c)b.on("click.assess","",d,function(c){c=$(c.data);a.assess(c)})})};b.prototype.updateAssessment=
function(c,a,b,d){0===c&&0===a||0===b||0===d||(c=this.getRowsContainer(c,a).find("ul li."+this.cssClasses.column+"["+this.dataAttributes.itemId+'="'+d+'"]['+this.dataAttributes.criteriaId+'="'+b+'"]'),this.assess(c,!0))};b.prototype.assess=function(c,a){void 0===a&&(a=!1);var b=c.parent(),d=c.hasClass(this.cssClasses.selectedBox);this.removeSelection(b);var e=this.getListItemData(c),k=e.key;e=e.value;d?(this.assessmentsData[k]=this.settings.rubricAssessmentCustomNull,this.hideComment(b)):(this.selectItem(c),
this.assessmentsData[k]=e,this.showComment(b));this.controls.updatedCriteriaAssessmentsHidden.val(JSON.stringify(this.assessmentsData)).trigger("change");this.settings.showOverride&&(c=b.parents("."+this.cssClasses.criteriaContainer),b=c.find("div."+this.cssClasses.overrideStatusBoxContainer).attr(this.dataAttributes.learningObjectiveId),d=c.find("div."+this.cssClasses.overrideStatusBoxContainer).attr(this.dataAttributes.learningObjectiveGroupId),this.updateAssessmentStatus(c.find("ul."+this.cssClasses.row),
b,d));a||(a=this.getPercentScoreByCriteriaAndWeight(),this.changeAssessmentOrScoreByPercentage(a))};b.prototype.changeAssessmentOrScoreByPercentage=function(c){this.settings.assessmentUpdaterSettings.connectAssessmentCriteriaToScale&&(this.settings.assessmentUpdaterSettings.useScore&&this.settings.callbacks.scoreSetValueFunction?this.settings.callbacks.scoreSetValueFunction(this.calculateScoreByPercent(c)):this.settings.assessmentUpdaterSettings.useAssessment&&this.settings.callbacks.assessmentSetValueFunction&&
this.settings.callbacks.assessmentSetValueFunction(this.calculateAssessmentGradeByPercent(c)),this.assessmentChangedWarningLabel.show())};b.prototype.calculateScoreByPercent=function(c){if(-1!==c){var a=Math.pow(10,2);c=(Math.round(this.settings.assessmentUpdaterSettings.maxScore*c/100*a)/a).toString();"."!==this.settings.assessmentUpdaterSettings.numberDecimalSeparator&&0<c.indexOf(".")&&(c=c.replace(".",this.settings.assessmentUpdaterSettings.numberDecimalSeparator));return c}return""};b.prototype.calculateAssessmentGradeByPercent=
function(c){var a=this.percentageKeys.filter(function(a){return c>=a});return this.settings.assessmentUpdaterSettings.assessmentPercentage[a[a.length-1]]};b.prototype.updateStatus=function(c,a,b,d,e){if(0!==c||0!==a){null==b&&(b=0);null==d&&(d=0);null==e&&(e="");var f=this.getRowsContainer(c,a).closest("."+this.cssClasses.criteriaContainer).find("div."+this.cssClasses.overrideStatusBoxContainer);this.setStatusOverridings(c,a,b,d,e,f)}};b.prototype.getRowsContainer=function(c,a){c=this.getLearningObjectiveClientId(c,
a);return window[this.grids[c]].getRowsContainer()};b.prototype.updateDescription=function(c,a,b,d){0===c&&0===a||0===b||null==d||""===d||(c=this.getRowsContainer(c,a).find("."+this.cssClasses.gridRow+"["+this.dataAttributes.id+'="'+b+'"]'),this.setDescription(b,d,c))};b.prototype.saveOverridings=function(){if(this.settings.showOverride){var c=this.controls.learningObjectiveIdHidden.val(),a=this.controls.learningObjectiveGroupIdHidden.val(),b=$("."+this.cssClasses.overrideStatusDropdown+" option:selected").val();
b=0<b.length?parseInt(b):0;var d=parseInt(this.settings.useMastery?$("."+this.cssClasses.overrideMasteryDropdown+" option:selected").val():0),e=$("."+this.cssClasses.overrideStatusComment).val().substring(0,this.settings.maximumCommentLength);this.saveOverridingsCommon(c,a,b,d,e,$("a[rel="+c+"]").parent())}};b.prototype.getLearningObjectiveClientId=function(c,a){return 0<a?"log"+a:c};b.prototype.saveOverridingsCommon=function(c,a,b,d,e,k){var f=this.getLearningObjectiveClientId(c,a),g=k.find("> span."+
this.cssClasses.statusBox),h=k.siblings("."+this.cssClasses.overrideMasterText).find("span."+this.cssClasses.masteredBoxHolder),q=h.find("> span");h=h.find("> img");var p=k.siblings("."+this.cssClasses.overrideComment);k=p.find("."+this.cssClasses.overrideCommentText);p=p.find("."+this.cssClasses.overrideCommentLabel);0<b?(this.overriddenAssessmentsData[f]={LearningObjectiveId:c,LearningObjectiveGroupId:a,Status:b,MasteryOption:d,Comment:e},this.settings.controls.overriddenCriteriaAssessmentsHidden.val(JSON.stringify(this.overriddenAssessmentsData)),
this.updateStatusTextAndCss(g,b),this.updateCommentText(k,p,e),this.settings.useMastery&&(this.possibleMasteredLearningObjectivesData[f].BreaksRecurrence&&d!==this.settings.learningObjectiveOverrideMasteryOption.mastered?this.updateMasteryTextAndCss(q,h,!1):(c=this.possibleMasteredLearningObjectivesData[f].AffectsByLevel,a=this.possibleMasteredLearningObjectivesData[f].AffectsByResettingMastery,f=this.possibleMasteredLearningObjectivesData[f].MasteredWithoutOverride,d===this.settings.learningObjectiveOverrideMasteryOption.mastered?
this.updateMasteryTextAndCss(q,h,!0):a&&(c?(b=this.getStartsAtByAssessmentStatusType(b),this.updateMasteryTextAndCss(q,h,b>=this.settings.masteryStartsAt)):this.updateMasteryTextAndCss(q,h,f))))):this.settings.useMastery&&(f=this.possibleMasteredLearningObjectivesData[f].MasteredWithoutOverride,this.updateMasteryTextAndCss(q,h,f))};b.prototype.setStatusOverridings=function(c,a,b,d,e,k){if(this.settings.showOverride){var f=k.attr(this.dataAttributes.statusDropdownId);window[f].selectItem(b);this.saveOverridingsCommon(c,
a,b,d,e,k)}};b.prototype.setDescription=function(c,a,b){b=b.find("li."+this.cssClasses.criteriaDescriptionRow);this.setDescriptionValue(b,a);this.descriptionsData[c]=a;this.controls.updatedCriteriaDecriptionsHidden.val(JSON.stringify(this.descriptionsData))};b.prototype.setDescriptionValue=function(c,a){""===a?c.find("a").text(this.settings.terms.watermark).addClass(this.cssClasses.criteriaItemEmptyState):c.find("a").text(a);c.find("input").val(a);c.find("textarea").val(a)};b.prototype.hideComment=
function(c){c.find("li."+this.cssClasses.criteriaDescriptionRow).hide()};b.prototype.showComment=function(c){c.find("li."+this.cssClasses.criteriaDescriptionRow).show()};b.prototype.removeSelection=function(c){c.children("li."+this.cssClasses.selectedBox).removeClass(this.cssClasses.selectedBox);c.find("li span."+this.cssClasses.star).removeClass(this.cssClasses.starOn).addClass(this.cssClasses.starOff)};b.prototype.selectItem=function(c){c.addClass(this.cssClasses.selectedBox);c.find("span."+this.cssClasses.star).removeClass(this.cssClasses.starOff).addClass(this.cssClasses.starOn)};
b.prototype.getListItemData=function(c){c=c.find("input[type=hidden]").val();return JSON.parse(c||"{}")};b.prototype.updateAssessmentStatus=function(c,a,b){var f=this,d=this.getLearningObjectiveClientId(a,b);if(this.settings.showOverride){var e=0,l=c.length;c.each(function(a,c){c=$(c);a=c.find("li."+f.cssClasses.column);c=c.find("li."+f.cssClasses.selectedBox);var b=a.index(c)+1;f.settings.achivementLevelOrderDirection===f.settings.achievementLevelOrder.lowestToHighest&&(b=$(a.get().reverse()).index(c)+
1);1<=b?e+=f.getPercentScoreByAchievementLevelId(b,a.length):l--});var m=e/l;c=c.parents("."+this.cssClasses.criteriaContainer);var n=c.find("div."+this.cssClasses.overrideStatusBoxContainer+"> span."+this.cssClasses.statusBox),q=c.find("span."+this.cssClasses.masteredBoxHolder);c=q.find("> span");q=q.find("> img");1<=m?this.assessmentStatusesData.forEach(function(c,e){e=(e=e+1<f.assessmentStatusesData.length?f.assessmentStatusesData[e+1]:null)?e.startsAt:f.settings.maximumPercentageValue;m>=c.startsAt&&
m<e&&(f.setAssessmentStatusByCriteria(c.type,a,b),null==f.overriddenAssessmentsData[d]&&f.updateStatusTextAndCss(n,c.type))}):(this.setAssessmentStatusByCriteria(this.settings.assessmentStatusTypeNotAssessed,a,b),null==this.overriddenAssessmentsData[d]&&this.updateStatusTextAndCss(n,this.settings.assessmentStatusTypeNotAssessed));if(this.settings.useMastery&&(null==this.overriddenAssessmentsData[d]||!this.overriddenAssessmentsData[d].MasteryOption))if(this.possibleMasteredLearningObjectivesData[d].BreaksRecurrence)this.updateMasteryTextAndCss(c,
q,!1);else{var p=this.possibleMasteredLearningObjectivesData[d],v=p.AffectsByLevel;p.AffectsByResettingMastery&&v&&(p=this.overriddenAssessmentsData[d],p=null==p?m:this.getStartsAtByAssessmentStatusType(p.Status),this.updateMasteryTextAndCss(c,q,p>=this.settings.masteryStartsAt))}}};b.prototype.setAssessmentStatusByCriteria=function(c,a,b){a=this.getLearningObjectiveClientId(a,b);this.assessmentStatusesByCriteriaData[a]=this.assessmentStatuses[c].Title;this.controls.assessmentStatusesByCriteriaHidden.val(JSON.stringify(this.assessmentStatusesByCriteriaData))};
b.prototype.updateMasteryTextAndCss=function(c,a,b){c.text(this.getMasteryText(b));c.removeClass(this.cssClasses.noPrint);c.addClass(this.settings.useMastery&&b?"":this.cssClasses.noPrint);a.prop("src",this.getMasteryImage(b));a.removeClass(this.cssClasses.noPrint);a.addClass(this.settings.useMastery&&b?"":this.cssClasses.noPrint)};b.prototype.getMasteryText=function(c){return this.settings.useMastery&&c?this.settings.terms.mastered:this.settings.terms.notMastered};b.prototype.getMasteryImage=function(c){return this.settings.useMastery&&
c?this.settings.imgUrls.masteredIcon:this.settings.imgUrls.notMasteredIcon};b.prototype.getPercentScoreByAchievementLevelId=function(c,a){return 100*(a-c+1)/a};b.prototype.updateStatusTextAndCss=function(c,a){$.each(this.assessmentStatuses,function(a,b){c.removeClass(b.CssClass)});c.addClass(this.assessmentStatuses[a].CssClass);c.text(this.assessmentStatuses[a].Title)};b.prototype.updateCommentText=function(c,a,b){a.parent().toggle(""!==b);c.text(b)};b.prototype.getPercentScoreByCriteriaAndWeight=
function(){var c=this,a=0,b=0,d=[];$("."+this.cssClasses.selectedBox).each(function(a,c){a=JSON.parse($(c).find("input[type=hidden]").val()||"{}");d[a.key]=a.value});$.each(this.settings.achievementLevelsPoints,function(f,e){if(d[f]&&0!==d[f]){var g=d[f],h=0;$.each(e,function(a,c){c>h&&(h=c)});a+=c.settings.achievementLevelsPoints[f][g];b+=h}});return 0<b?a/b*100:-1};b.prototype.getStartsAtByAssessmentStatusType=function(c){for(var a=0,b=0;b<this.assessmentStatusesData.length;b++){var d=this.assessmentStatusesData[b];
if(d.type===c){a=d.startsAt;break}}return a};b.prototype.getAssessmentStatusTypeByStartsAt=function(c){for(var a=this,b="",d=Object.keys(this.assessmentStatusesData).map(function(c){return a.assessmentStatusesData[c]}).reverse(),e=0;e<d.length;e++){var k=d[e];if(c>=k.startsAt){b=k.type;break}}return b};b.prototype.createCommentsInlineEdit=function(c){var a=this;c.find("."+this.cssClasses.criteriaLevelDescription).each(function(c,b){c={submitOnEnter:!0,multiline:!0,autoResize:!0,editFieldCssClass:a.cssClasses.inlineEditor,
maxLength:1024};new ClientInlineEditor($(b),void 0,$(b).parent().find("input").last(),c,function(c,b){return a.onEditCriteriaDescription(c,b)},function(c){return a.onChangeInlineEditModeFunction(c)},void 0)})};b.prototype.onEditCriteriaDescription=function(c,a){var b=this.getCriteriaId(c.source);this.descriptionsData[b]=c.actualText;this.controls.updatedCriteriaDecriptionsHidden.val(JSON.stringify(this.descriptionsData));c.isUpdateSuccess=!0;a(c)};b.prototype.onChangeInlineEditModeFunction=function(c){var a=
c.source;c.isEditMode||a.parent().find("input").last().val()?a.removeClass(this.cssClasses.criteriaItemEmptyState):(a.addClass(this.cssClasses.criteriaItemEmptyState),a.text(this.settings.terms.watermark))};b.prototype.getCriteriaId=function(c){return c.parents("ul").next().val()};return b}();b.RubricAssessment=e})(CCL||(CCL={}));
...
1)[0]};c.prototype.RemoveSelectedFileByFileId=function(a){if(this._selectedFiles)for(var c=this._selectedFiles.length;c--;)if(this._selectedFiles[c].id===a)return this._selectedFiles.splice(c,1)[0]};c.prototype.RemoveFile=function(a,c){for(var d=this.GetFiles(),f=0===c.siblings().length,e=d.length;e--;)if(d[e].name===a){d[e].deleteUrl&&$.ajax({url:d[e].deleteUrl+"&"+this._settings.MethodOverrideQueryStringParam+"=delete",type:"DELETE",xhrFields:{withCredentials:!0}});d.splice(e,1);break}d=this.ValidateSelectedFiles(d,
null);c.remove();this.RemoveSelectedFile(a);this.Trigger(b.PickerEvent.ResultsChanged,{results:d});a=!d.length&&!this._settings.MultiselectAllowed;f=f&&this._settings.MultiselectAllowed&&this.AllUploadsFinished();if(a||f)this._settings.ReadOnly||this._chooseButton.show(),this.HandleStopped({results:[]})};c.prototype.AllUploadsFinished=function(){var a=!0;this._selectedFiles&&this._selectedFiles.forEach(function(c){c.error||(a=!1)});return a};c.prototype.HandleStopped=function(a){this.stopPolling();
...
b){var d=new RegExp("([?&])"+a+"=.*?(&|$)","i"),f=-1!==c.value.indexOf("?")?"&":"?";c.value.match(d)?c.value=c.value.replace(d,"$1"+a+"="+b+"$2"):c.value=c.value+f+a+"="+b}}}();b.Url=e})(Utils||(Utils={}));var UrlUtilities=Utils;
...
40));var f=c.contentContainer.outerHeight(!0)-c.contentContainer.height();if(a.PreferredHeight&&0<a.PreferredHeight){var e=c.wrapperContainer.outerHeight()-c.contentContainer.height();c.contentContainer.outerHeight(a.PreferredHeight-e+f,!0)}else c.contentContainer.height(c.wrapperContainer.outerHeight()-d-f);c.contentContainer.css({width:a.MinContentWidth&&0<a.MinContentWidth?a.MinContentWidth:void 0,minWidth:a.MinContentWidth&&0<a.MinContentWidth?a.MinContentWidth:void 0,minHeight:a.MinContentHeight&&
0<a.MinContentHeight?a.MinContentHeight:void 0});a=c.wrapperContainer.outerHeight()-c.headerContainer.outerHeight();c.contentContainer.outerHeight()-1>a&&c.contentContainer.outerHeight(a);a=c.wrapperContainer.height()/2;f=c.wrapperContainer.width()/2;c.wrapperContainer.css({left:"50%","margin-left":-1*f,"margin-top":-1*a,top:"50%"})}else c.contentContainer.outerHeight(c.wrapperContainer.height()-d);null==navigator.userAgent.match(/iPod/)&&$(c.contentContainer).perfectScrollbar("update")};c.prototype.toggleContentAreaFrame=
...
e=function(){function a(){b.CommonFunctions.attachPostMessageEventListener($(window),[b.CommonWindowMessages.MessageNames.contentAreaFrameHasExpanded],function(a){b.OverlayModal.instance&&!b.OverlayModal.instance.getIsOpened()&&setTimeout(b.OverlayModal.instance.openModal(),20)})}a._initEventListener=new a;return a}();b.OverlayModalListener=e;(function(a){a.fn.overlayModal=function(b,d){var f={container:this,contentContainer:this.find("."+c.CssClasses.Content),wrapperContainer:this.find("."+c.CssClasses.Wrapper),
headerContainer:this.find("."+c.CssClasses.Header)};b instanceof Object&&a.extend(void 0,b);f=new c(f.container.get(0).id,b,f);f.Params=d;switch(b){case "open":f.open();break;case "close":f.close()}return this}})(jQuery)})(CCL||(CCL={}));var PopupInitFailureReason;(function(b){b[b.BrowserNotSupported=1]="BrowserNotSupported";b[b.ExternalServiceNotAvailable=2]="ExternalServiceNotAvailable"})(PopupInitFailureReason||(PopupInitFailureReason={}));
...
$();return this._loadMoreLinkContainer};c.prototype.createCommentList=function(a){this._list=$("<ul>").addClass(this._cmm.settings.CssClasses.CommentList);this.fillCommentList(a,!0);return this._list};c.prototype.fillCommentList=function(a,c){var b=this;a&&(c||(a=a.reverse()),$.each(a,function(a,d){b.renderComment(d,c,!1);if(-1===b._newestCommentId||d.Id>b._newestCommentId)b._newestCommentId=d.Id;if(-1===b._oldestCommentId||d.Id<b._oldestCommentId)b._oldestCommentId=d.Id}));this._list.toggle(!this._list.is(":empty"))};
...
this.ProcessFileName(this._selectedFiles[a].name);this.UpdateFileList(this._selectedFiles);var b=[];if(0<this._selectedFiles.length){var d={};d.Authorization="Bearer "+gapi.auth.getToken().access_token;this._selectedFiles.forEach(function(a){var e=c.ComposeDownloadUrl(a.fileId);$.support.cors||(e=c._settings.GoogleDriveProxy+encodeURIComponent(e));b.push($.ajax({url:e,type:"GET",data:"",headers:d,success:function(b){var d=!1;if(b.downloadUrl)a.fileUrl=b.downloadUrl+"&"+c._settings.TokenPlaceholderInQuerystring+
...
function(){a.ToggleOkButton(!0);a.Trigger(b.PickerEvent.Started)}).on("fileuploadadd",function(c){for(var d=[],e=1;e<arguments.length;e++)d[e-1]=arguments[e];a.Trigger(b.PickerEvent.Added,d[0])}).on("fileuploadstopped",function(c){for(var d=[],e=1;e<arguments.length;e++)d[e-1]=arguments[e];d[0].results=a.fileUploaderContainer.fileupload("getUploadedFiles");a.Trigger(b.PickerEvent.Stopped,d[0]);a.ToggleOkButton(!1)}).on("fileuploadresultschanged",function(c){for(var d=[],e=1;e<arguments.length;e++)d[e-
1]=arguments[e];a.Trigger(b.PickerEvent.ResultsChanged,d[0])}).on("fileuploadsubmit",function(c){for(var b=[],d=1;d<arguments.length;d++)b[d-1]=arguments[d];b=b[0];b.url=a.GetFileRepoUrlForFileName(a.ProcessFileName(b.files[0].name));b.xhrFields={withCredentials:!0}}).on("fileuploaddestroy",function(c){for(var b=[],d=1;d<arguments.length;d++)b[d-1]=arguments[d];b=b[0];b.url&&(b.url+="&"+a._settings.MethodOverrideQueryStringParam+"=delete");b.type="DELETE";b.xhrFields={withCredentials:!0}}).on("fileuploaddone",
...
(function(b){b.FileRepoUploaderEvent={PickerChanged:"FileRepoUploaderPickerChanged",ResultsChanged:"FileRepoUploaderResultsChanged"};var e=function(d){function c(a,c){var e=this;d.call(this,a);this._pickers=[];this._inlineModeFileList=[];this._inlineModeFileKeys={};this._removedFiles=[];this._changedFiles={};this._settings=c;this._currentTabIndex=-1;FileRepoUploaderInstance=this;$("#"+this._settings.ControlTabsClientId).on(b.ControlTabsEvent.TabIndexChanged,function(a){for(var c=[],d=1;d<arguments.length;d++)c[d-
1]=arguments[d];e._currentTabIndex!==c[0].selectedTab&&(e._currentTabIndex=c[0].selectedTab,(c=e._pickers[e._currentTabIndex])&&e.Trigger(b.FileRepoUploaderEvent.PickerChanged,{selectedPicker:c}))});this._elem.on(b.PickerEvent.Initialized,function(a){a=b.DomElementClass.GetInstanceForElement(a.target.id);e._pickers.push(a);1==e._pickers.length&&e._settings.IsEmpty&&e.Trigger(b.FileRepoUploaderEvent.PickerChanged,{selectedPicker:e._pickers[0]})});this._elem.on(b.PickerEvent.ResultsChanged,function(a){for(var c=
[],d=1;d<arguments.length;d++)c[d-1]=arguments[d];d=b.DomElementClass.GetInstanceForElement(a.target.id);c=c[0].results;var f=e._settings.ReadOnly?e.GetControlTabs().GetCurrentTab():e._pickers.indexOf(d);e.GetControlTabs().SetCurrentTab(f);e.HandleResultsChanges(c,f);e.Trigger(b.FileRepoUploaderEvent.ResultsChanged,{results:c,picker:d})});this._elem.on(b.PickerEvent.Started,function(a){for(var c=1;c<arguments.length;c++);c=b.DomElementClass.GetInstanceForElement(a.target.id);c=e._settings.ReadOnly?
e.GetControlTabs().GetCurrentTab():e._pickers.indexOf(c);e.HandleResultsChanges([{}],c)});if(c.InlineMode)this._elem.on(b.PickerEvent.Added,function(a){for(var b=[],d=1;d<arguments.length;d++)b[d-1]=arguments[d];(c.UniqueFileNamesOnly||e.CanCheckFileNames())&&b[0].files.forEach(function(a){c.UniqueFileNamesOnly&&e._filesContainer.find("td.name").toArray().forEach(function(b){if(b.innerText===a.name)if(confirm(c.FileAlreadyExistsDialogText.replace("{0}",a.name))){b=$(b).closest("."+c.FileListRowCssClass);
var d=b.find("a."+c.RemoveActionCssClass);d=$(d).data("filekey");d=e.GetFileByKey(d);e.RemoveFile(d,b)}else a.error=c.FileAlreadyExistsErrorMessage});!a.error&&e.CanCheckFileNames()&&(a.error=e.GetFileNameValidation(a.name))})}),this._elem.on(b.PickerEvent.Stopped,function(a){for(var c=[],d=1;d<arguments.length;d++)c[d-1]=arguments[d];e.UpdateFileList(c[0].results,!0,null);e.UpdateFileListState(e._inlineModeFileList);d=c[0].results&&0<c[0].results.length&&e._expandableContainer.getIsExpandedState();
var f=b.DomElementClass.GetInstanceForElement(a.target.id);f.ClearResults(c[0].results);d&&f.AllowHide()&&e._expandableContainer.toggle()}),this._elem.on("hybrideditoritemtextupdated",function(a){for(var d=[],f=1;f<arguments.length;f++)d[f-1]=arguments[f];f=$(a.target).closest("."+c.FileListRowCssClass);var g=f.find("a."+c.RemoveActionCssClass);g=$(g).data("filekey");g=e.GetFileByKey(g);d=d[0].value;d||(d="(empty)",f.find("."+c.FileNameContainerCssClass).text(d));g.rawFilename=d;g.name=g.rawFilename;
g.extension&&(g.name+=g.extension);e._changedFiles[g.id]=g;e._changedFilesStateHidden.val(JSON.stringify(e._changedFiles));e.UpdateFileListState(e._inlineModeFileList);d=e._pickers[e.GetControlTabs().GetCurrentTab()];e.Trigger(b.FileRepoUploaderEvent.ResultsChanged,{results:e._inlineModeFileList,picker:d})}),this._expandableContainer=new ExpandableContainer(this._elem,{expander:$("#"+this._settings.ExpandableHeaderClientId),target:$("#"+this._settings.ExpandableContentClientId)}),this._filesContainer=
$("#"+c.FileListContainerId),this._filesContainer.on("click","."+this._settings.RemoveActionCssClass,function(a){var c=$(a.target).data("filekey");c=e.GetFileByKey(c);a=$(a.target).closest("."+e._settings.FileListRowCssClass);e.RemoveFile(c,a)}),this._filesContainer.on("click","."+this._settings.ViewActionCssClass,function(a){a=$(a.target).data("filekey");a=e.GetFileByKey(a);e.OpenFile(a,!0)}),this._filesContainer.on("click","."+this._settings.EditActionCssClass,function(a){a=$(a.target).data("filekey");
...
function(c,b){c=new d.FileName(c);b=new a({fileName:c,stateMachine:new d.FileItemStateMachine,iconCssClass:a.getCssIconForFile(a.getFilePurpose(c.getExtension().toLowerCase())),metadata:b});b.isSupportedByCasper(!0);return b};a.buildItemForFolder=function(c){return new a({fileName:new d.FileName(c,void 0,!0),stateMachine:new d.FileItemStateMachine,iconCssClass:"ccl-fl-item-details-folder-icon"})};a.buildItemForFileInCloud=function(c){var b=new a({fileName:new d.FileName(c.name),stateMachine:new d.FileItemStateMachine,
...
(function(b){(function(e){var d=function(){function c(a,d){var e=this;this.settings=a;this.fileActions=d;this.isItslearningEmbedded=!1;this.openPreview=function(a,d){void 0===d&&(d=!1);var f=a.PreviewSettings?a.PreviewSettings:c.getDefaultPreviewSettings(a.IsFileInCloud,a.MimeType,e.settings),g=d?b.PreviewType.NewTab:f.Type;d=!d&&f.Url?f.Url:a.IsFileInCloud?e.fileActions.getEditUrl(a):e.fileActions.getViewUrl(a);switch(g){case b.PreviewType.None:e.download(a);break;case b.PreviewType.NewPopup:e.openInPopup(d);
break;case b.PreviewType.NewTab:e.openInTab(d);break;case b.PreviewType.SameFrame:e.openInSameFrame(d);break;case b.PreviewType.Modal:e.openInModalDialog(a.Name,d,f.DialogWidth,f.DialogHeight,f.DialogMaximised)}};b.CommonFunctions.attachPostMessageEventListener($(window),b.CommonWindowMessages.MessageNames.replyIfItslearningIsEmbedded,function(){e.isItslearningEmbedded=!0});this.settings.PreviewDialogInstanceName&&window[this.settings.PreviewDialogInstanceName]&&b.CommonFunctions.makePostMessageCall(window.parent,
new b.CommonWindowMessages.GenericMessage(b.CommonWindowMessages.MessageNames.askWhetherItslearningIsEmbedded))}c.getDefaultPreviewSettings=function(a,d,e){return e.MimeTypesToView.some(function(a){return a===d})?a?{Type:b.PreviewType.NewTab}:c.shouldBeOpenedInPopup(d,e)?{Type:b.PreviewType.NewPopup}:{Type:b.PreviewType.Modal,DialogWidth:c.isEmbeddedVideo(d,e)?c.videoMinWidth:0,DialogHeight:c.isEmbeddedVideo(d,e)?c.videoMinHeight:0,DialogMaximised:!1}:{Type:b.PreviewType.None}};c.shouldBeOpenedInPopup=
function(a,c){return this.isOwasFileType(a,c)||0<=c.AdditionalMimeTypesOpenedInPopup.indexOf(a)};c.isOwasFileType=function(a,c){return 0<=c.OwasMimeTypes.indexOf(a)};c.isEmbeddedVideo=function(a,c){return!!a&&0<=c.EmbedVideoMimeTypes.indexOf(a)};c.prototype.openEdit=function(a){var c=this.fileActions.getEditUrl(a);a.IsFileInCloud&&this.settings.GoogleMimeTypes.some(function(c){return c===a.MimeType})?this.openInTab(c):this.openInPopup(c)};c.prototype.openView=function(a,c){void 0===c&&(c=!1);c=this.settings.UsePreviewSettingsUrlToView&&
a.PreviewSettings.Url&&!c?a.PreviewSettings.Url:this.fileActions.getViewUrl(a,c);a.IsFileInCloud&&this.settings.GoogleMimeTypes.some(function(c){return c===a.MimeType})?this.openInTab(c):this.openInPopup(c)};c.prototype.download=function(a){a=this.fileActions.getDownloadUrl(a);contract.require(!objectState.isNullOrUndefined(a),"No download url for file.");this.isItslearningEmbedded?this.open(a):this.openInTab(a)};c.prototype.open=function(a){window.open(a,"_self")};c.prototype.openInTab=function(a){this.isItslearningEmbedded&&
(a=this.getIntermediatePageUrl(a));window.open(a)};c.prototype.openInPopup=function(a){this.isItslearningEmbedded&&(a=this.getIntermediatePageUrl(a));window.open(a,"","width="+.8*screen.width+", height="+.8*screen.height+",location=0, directories=0, toolbar=0, scrollbars=0, status=0, menubars=0, resizable=1")};c.prototype.openInModalDialog=function(a,b,d,e,k){void 0===k&&(k=!1);var f=window[this.settings.PreviewDialogInstanceName];f&&(f.setAjaxUrl(b),f.setTitle(a),f.setContentMinSize(d,e),0<e&&f.setContentMaxSize(d,
c.maxHeight),f.openDialog(k))};c.prototype.openInSameFrame=function(a){window.location.href=a};c.prototype.getIntermediatePageUrl=function(a){return this.settings.IntermediatePageUrl?this.settings.IntermediatePageUrl.replace(this.settings.TemplateTokens.FileUrl,encodeURIComponent(a)):a};c.videoMinWidth=650;c.videoMinHeight=350;c.maxHeight=600;return c}();e.PreviewerControl=d})(b.FileList||(b.FileList={}))})(CCL||(CCL={}));
...
a.prototype.transformFiles=function(a){var c=this;return ko.utils.arrayMap(a,function(a){var d=new b.Model.FileName(a.Name);a=new b.Model.FileItem({fileName:d,stateMachine:new b.Model.FileItemStateMachine,metadata:a.Metadata,iconCssClass:a.IsFileInCloud?b.Model.FileItem.getCssIconForFileInCloud(a.Metadata):b.Model.FileItem.getCssIconForFile(b.Model.FileItem.getFilePurpose(d.getExtension().toLowerCase())),previewSettings:a.PreviewSettings,noInteraction:c.settings.NoInteraction,rightSideCustomHtml:a.RightSideCustomHtml,
...
b.OnControlInitializationError:void 0),fileUploadAborted:e.getFunctionByName(b?b.OnFileUploadAborted:void 0)}}function DelayRequest(b){var e={callbacks:[],current:0,signalled:0,running:!1,runCallbacks:function(b){if(!e.running){for(e.running=!0;e.current<e.signalled&&e.current<e.callbacks.length;)e.callbacks[e.current](b),e.current+=1;e.running=!1}}},d={data:b,wait:function(b){e.callbacks.push(b);e.runCallbacks(this);return d},signal:function(){e.signalled+=1;e.runCallbacks(this)}};return d}
...
case c.Action.CANCEL:g.onFileSelectionCanceled(a)}},getFileDownloadUrl:function(a){return g.baseDownloadUrl.replace("{fileId}",a[c.Document.ID])},getFileInfo:function(a){var b={fileId:null,size:null,name:null};b.fileId=guidFactory.newGuid();1===a.length?(b.size=a[0].size,b.name=a[0].name):(b.size=a.reduce(function(a,b){return a+b.size},0),b.name=d.files);return b},getParameterValue:function(a,b){for(var c=[],d=a.slice(a.indexOf("?")+1).split("&"),e=0;e<d.length;e++)a=d[e].split("="),c.push(a[0]),
c[a[0]]=a[1];return c[b]},signalIfDoneProcessing:function(a){a.processed+=1;a.processed>=a.total&&a.delayed.signal()},getMetadataUrl:function(a){return a.isSpreadSheet?b.googleDriveProxy+encodeURIComponent(a.url):a.url},getFileSize:function(a){var b=0;a=$.ajax({url:g.getMetadataUrl(a),type:"HEAD",data:"",async:!1});200==a.status&&(b=parseInt(a.getResponseHeader("Content-Length")));return b},checkFileSize:function(a){0==a.size&&(a.size=this.getFileSize(a))},getDownloadUrl:function(a,b){$.ajax({url:g.getMetadataUrl(a),
...
size:a.sizeBytes,isSpreadSheet:"application/vnd.google-apps.spreadsheet"===a.mimeType,fileId:a[c.Document.ID],type:a[c.Document.MIME_TYPE],icon:a[c.Document.ICON_URL]}});g.hasCurrentFileUploadEnded=!1;return b},executeFileSelectedCallback:function(a){a=a.data.request.files;void 0!==f.fileSelected&&f.fileSelected(a)},getDownloadUrlForFiles:function(a){var b=a.data.request.files,c={total:b.length,processed:0,delayed:a};b.forEach(function(a){g.getDownloadUrl(a,c)})},onControlInitializationError:function(a){f.controlInitializationError&&
